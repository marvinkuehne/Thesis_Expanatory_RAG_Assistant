...
Updates the specified VLAN. Note that this operation might require
changes to all the VNICs in the VLAN, which can take a while. The VLAN
will be in the UPDATING state until the changes are complete.
...
The CIDR block of the VLAN. The new CIDR block must meet the following
criteria:
...
information about NSGs, see NetworkSecurityGroup. This is a complex
