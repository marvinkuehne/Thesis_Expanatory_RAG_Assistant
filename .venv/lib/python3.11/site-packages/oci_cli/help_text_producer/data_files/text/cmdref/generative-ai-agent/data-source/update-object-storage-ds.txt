...
--data-source-config-object-storage-prefixes [complex type]

The locations of data items in Object Storage, can either be an object
(File) or a prefix (folder).

This option is a JSON list with items of type ObjectStoragePrefix.
For documentation on ObjectStoragePrefix please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/generativeaiagent/2024053
1/datatypes/ObjectStoragePrefix. This is a complex type whose value
...
--data-source-config-should-enable-multi-modality [boolean]

Flag to enable or disable multi modality such as image processing
while ingestion of data. True enable the processing and false exclude
the multi modality contents during ingestion.
