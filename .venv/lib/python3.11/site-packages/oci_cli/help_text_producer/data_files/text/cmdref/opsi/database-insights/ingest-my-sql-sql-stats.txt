...
The MySql SQL Stats endpoint takes in a JSON payload, persists it in
Ops Insights ingest pipeline. Either databaseId or id must be
specified.
...
This option is a JSON list with items of type MySqlSqlStats.  For
documentation on MySqlSqlStats please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/operationsinsights/20200630/datatypes/MySqlSqlStats.
