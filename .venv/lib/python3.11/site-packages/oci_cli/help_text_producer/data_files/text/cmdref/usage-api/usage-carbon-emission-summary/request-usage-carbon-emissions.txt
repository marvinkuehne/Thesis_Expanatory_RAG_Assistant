...
--compartment-depth [integer]

The compartment depth level.

--emission-calculation-method [text]

Specifies the method used for emission calculation, such as
POWER_BASED or SPEND_BASED

Accepted values are:

   POWER_BASED, SPEND_BASED

--emission-type [text]

Specifies the type of emission, such as MARKET_BASED or
LOCATION_BASED.
...
The carbon emission granularity. DAILY - Daily data aggregation.
...
“region”, “logicalAd”,     “resourceId”, “resourceName”, “tenantId”,
“tenantName”, “subscriptionId”]* This is a complex type whose value
...
all carbon emissions usage over the query time period are summed.
