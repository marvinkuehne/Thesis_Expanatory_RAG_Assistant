...
Update the metadata of a Backup. Metadata such as the displayName or
description
...
Retains the backup to be deleted due to the retention policy in DELETE
SCHEDULED state for 7 days before permanently deleting it.
...
--wait-for-state" CREATING "--wait-for-state" DELETE_SCHEDULED would
...
Accepted values are:
   ...
   ACTIVE, CREATING, DELETED, DELETE_SCHEDULED, DELETING, FAILED, INACTIVE, UPDATING
