...
Updates the network security groups associated with the specified
...
=====
   ...
   oci nlb network-load-balancer update-network-security-groups [OPTIONS]
...
An array of network security group OCIDs associated with the network
load balancer.

During the creation of the network load balancer, the service adds the
new network load balancer to the specified network security groups.
...
security policies before trying the examples.
       ...
       oci nlb network-load-balancer update-network-security-groups --network-load-balancer-id $network_load_balancer_id
