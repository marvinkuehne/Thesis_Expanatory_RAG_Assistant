...
Create a new report in the specified format containing the download
details for the tenancy.
...
The end time until when the download records have to be included
...
The start time from when download records have to be included
(formatted according to RFC3339).
