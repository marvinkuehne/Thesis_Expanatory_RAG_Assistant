...
--download-size-limit-in-bytes [integer]

Download size limit in Bytes, at which to stop the transfer. Maximum
download size limit is 5 MiB.
...
--ftp-basic-authentication-details [complex type]
...
reference: https://docs.oracle.com/en-us/iaas/api/#/en/apmsynthetic/2
0200630/datatypes/MonitorScriptParameter. This is a complex type whose
...
--upload-file-size-in-bytes [integer]

File upload size in Bytes, at which to stop the transfer. Maximum
upload size is 5 MiB.

--verify-response-codes [complex type]

Expected FTP response codes. For status code range, set values such as
2xx, 3xx. This is a complex type whose value must be valid JSON. The
