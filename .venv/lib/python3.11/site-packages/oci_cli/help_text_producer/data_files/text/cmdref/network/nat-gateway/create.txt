...
Creates a new NAT gateway for the specified VCN. You must also set up
a route rule with the NAT gateway as the rule’s target. See Route
Table.
...
Whether the NAT gateway blocks traffic through it. The default is
*false*.
...
If you don’t specify a route table here, the NAT gateway is created
