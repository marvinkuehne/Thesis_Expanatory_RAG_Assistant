...
=====
   ...
   oci network subnet remove-ipv4-subnet-cidr [OPTIONS]
...
This field should only be specified when removing an IPv4 prefix from
a subnet’s IPv4 address space. The CIDR must maintain the following
rules -

1. The CIDR block is valid and correctly formatted. b. The CIDR range
   is within one of the parent VCN ranges. c. The CIDR range to be
   removed is already present in the list of ipv4CidrBlocks
...
security policies before trying the examples.
       ...
       export ipv4_cidr_block=<substitute-value-of-ipv4_cidr_block> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/subnet/remove-ipv4-subnet-cidr.html#cmdoption-ipv4-cidr-block
       ...
       oci network subnet remove-ipv4-subnet-cidr --ipv4-cidr-block $ipv4_cidr_block --subnet-id $subnet_id
