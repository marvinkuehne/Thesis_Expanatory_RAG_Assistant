...
--user-capabilities-changer-id [text]
...
--can-use-console [boolean]

Indicates whether a user can use the Console.

**SCIM++ Properties:**  - caseExact: false  - idcsSearchable: true  -
multiValued: false  - mutability: readWrite  - idcsDefaultValue: false
...
--can-use-db-credentials [boolean]
...
--can-use-o-auth2-client-credentials [boolean]
