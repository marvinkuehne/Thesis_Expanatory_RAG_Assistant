...
Creates Oracle DB Azure Connector resource and configured Azure
Identity in Oracle Database resource.


Usage
=====

   oci dbmulticloud oracle-db-azure-connector create [OPTIONS]


Required Parameters
===================

--azure-identity-mechanism [text]
...
The OCID of the compartment that contains Oracle DB Azure Connector
resource.

--db-cluster-resource-id [text]

The OCID of the Oracle DB Cloud VM Cluster resource where this Azure
Arc Agent Identity to configure.
