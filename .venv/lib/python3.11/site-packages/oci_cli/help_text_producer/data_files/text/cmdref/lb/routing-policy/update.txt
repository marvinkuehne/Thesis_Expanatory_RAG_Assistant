...
Use this operation to add, delete, or alter routing policy rules in a
routing policy.

To add a new routing rule to a routing policy, the body must include
both the new routing rule to add and the existing rules to retain.
...
The OCID of the load balancer associated with the routing policy to
update.
...
The list of routing rules. This is a complex type whose value must be
...
--condition-language-version [text]

The version of the language in which *condition* of *rules* are
composed.
