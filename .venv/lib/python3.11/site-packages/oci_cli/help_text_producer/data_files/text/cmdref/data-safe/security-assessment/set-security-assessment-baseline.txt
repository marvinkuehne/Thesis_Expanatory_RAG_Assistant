...
Sets the saved security assessment as the baseline in the compartment
where the the specified assessment resides. The security assessment
...
--assessment-ids [complex type]

The list of OCIDs for the security assessments that need to be updated
while setting the baseline. This is a complex type whose value must be
