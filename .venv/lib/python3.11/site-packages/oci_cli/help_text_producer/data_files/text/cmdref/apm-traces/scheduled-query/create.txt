...
=====
   ...
   oci apm-traces scheduled-query create [OPTIONS]
...
--retention-criteria [text]

Retention criteria for the scheduled query.

Accepted values are:

   KEEP_DATA_UNTIL_RETENTION_PERIOD, UPDATE

--retention-period-in-ms [integer]
...
security policies before trying the examples.
       ...
       export apm_domain_id=<substitute-value-of-apm_domain_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/apm-traces/scheduled-query/create.html#cmdoption-apm-domain-id

       oci apm-traces scheduled-query create --apm-domain-id $apm_domain_id
