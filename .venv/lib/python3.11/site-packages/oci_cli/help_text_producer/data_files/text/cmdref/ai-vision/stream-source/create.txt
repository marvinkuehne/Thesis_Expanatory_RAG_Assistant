...
=====
   ...
   oci ai-vision stream-source create [OPTIONS]
...
--stream-source-details [complex type]
...
security policies before trying the examples.
       ...
       oci ai-vision stream-source create --compartment-id $compartment_id --stream-source-details file://stream-source-details.json
