...
connection to an instance. To disconnect the volume from a connected
instance, see Disconnecting From a Volume. **Warning:** All data on
the volume will be permanently lost when the volume is deleted.
