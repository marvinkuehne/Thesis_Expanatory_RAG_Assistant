...
=====
   ...
   oci wlms wls-domain delete [OPTIONS]
...
security policies before trying the examples.
       ...
       export wls_domain_id=<substitute-value-of-wls_domain_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/wlms/wls-domain/delete.html#cmdoption-wls-domain-id

       oci wlms wls-domain delete --wls-domain-id $wls_domain_id
