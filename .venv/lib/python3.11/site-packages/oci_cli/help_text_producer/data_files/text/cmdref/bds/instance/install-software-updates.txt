...
=====
   ...
   oci bds instance install-software-updates [OPTIONS]
...
--software-update-keys [complex type]

A list of unique identifiers of target software updates. This is a
...
example parameters with your own.
       ...
       oci bds instance install-software-updates --generate-param-json-input software-update-keys > software-update-keys.json
...
security policies before trying the examples.
       ...
       export bds_instance_id=<substitute-value-of-bds_instance_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bds/instance/install-software-updates.html#cmdoption-bds-instance-id

       oci bds instance install-software-updates --bds-instance-id $bds_instance_id --software-update-keys file://software-update-keys.json
