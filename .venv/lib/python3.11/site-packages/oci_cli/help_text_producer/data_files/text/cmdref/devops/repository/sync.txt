...
The branch in the repository we want to be updated with changes from
the upstream.
...
--sync-merge-strategy [text]

If fetch and merge is passed in, the changes from the upstream will be
fetched and merged into the destination branch. If discard is passed
in, the changes in the fork will be overwritten with the changes
brought in from the upstream.
