...
Moves a Fleet into a different compartment within the same tenancy.
...
=====
   ...
   oci fleet-apps-management fleet change-compartment [OPTIONS]
...
The OCID of the compartment to move the Fleet to.
...
security policies before trying the examples.
       ...
       oci fleet-apps-management fleet change-compartment --compartment-id $compartment_id --fleet-id $fleet_id
