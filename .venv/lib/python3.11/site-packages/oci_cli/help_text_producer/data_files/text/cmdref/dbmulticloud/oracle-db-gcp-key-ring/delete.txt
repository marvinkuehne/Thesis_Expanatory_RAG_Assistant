...
=====
   ...
   oci dbmulticloud oracle-db-gcp-key-ring delete [OPTIONS]
...
security policies before trying the examples.
       ...
       oci dbmulticloud oracle-db-gcp-key-ring delete --oracle-db-gcp-key-ring-id $oracle_db_gcp_key_ring_id
