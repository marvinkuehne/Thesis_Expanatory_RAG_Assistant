...
Edit credential associated with a fleet or with a product/target with
in a fleet.
...
security policies before trying the examples.
       ...
       fleet_credential_id=$(oci fleet-apps-management fleet-credential create --display-name $display_name --entity-specifics file://entity-specifics.json --fleet-id $fleet_id --password file://password.json --user file://user.json --query data.id --raw-output)
