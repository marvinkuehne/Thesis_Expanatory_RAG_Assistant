...
=====
   ...
   oci apiaccesscontrol privileged-api-requests revoke [OPTIONS]
...
Comment specified by the approver explaining why the approval is
revoked.
...
security policies before trying the examples.
       ...
       export privileged_api_request_id=<substitute-value-of-privileged_api_request_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/apiaccesscontrol/privileged-api-requests/revoke.html#cmdoption-privileged-api-request-id

       oci apiaccesscontrol privileged-api-requests revoke --privileged-api-request-id $privileged_api_request_id
