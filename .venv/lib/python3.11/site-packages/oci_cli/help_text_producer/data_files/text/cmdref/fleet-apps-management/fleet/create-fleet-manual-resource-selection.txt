"create-fleet-manual-resource-selection"
****************************************
...
=====
   ...
   oci fleet-apps-management fleet create-fleet-manual-resource-selection [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fleet-apps-management/fleet/create-fleet-manual-resource-selection.html#cmdoption-compartment-id
       export display_name=<substitute-value-of-display_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fleet-apps-management/fleet/create-fleet-manual-resource-selection.html#cmdoption-display-name

       oci fleet-apps-management fleet create-fleet-manual-resource-selection --compartment-id $compartment_id --display-name $display_name
