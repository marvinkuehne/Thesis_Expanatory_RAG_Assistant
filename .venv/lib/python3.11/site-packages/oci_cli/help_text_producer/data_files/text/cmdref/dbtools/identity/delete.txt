...
=====
   ...
   oci dbtools identity delete [OPTIONS]
...
security policies before trying the examples.
       ...
       export identity_id=<substitute-value-of-identity_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/identity/delete.html#cmdoption-identity-id

       oci dbtools identity delete --identity-id $identity_id
