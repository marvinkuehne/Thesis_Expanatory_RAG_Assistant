...
=====
   ...
   oci kafka cluster delete [OPTIONS]
...
security policies before trying the examples.
       ...
       export kafka_cluster_id=<substitute-value-of-kafka_cluster_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/kafka/cluster/delete.html#cmdoption-kafka-cluster-id

       oci kafka cluster delete --kafka-cluster-id $kafka_cluster_id
