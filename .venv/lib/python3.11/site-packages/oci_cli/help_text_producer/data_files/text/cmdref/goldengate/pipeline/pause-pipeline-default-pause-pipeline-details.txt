...
=====
   ...
   oci goldengate pipeline pause-pipeline-default-pause-pipeline-details [OPTIONS]
...
security policies before trying the examples.
       ...
       export pipeline_id=<substitute-value-of-pipeline_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/pipeline/pause-pipeline-default-pause-pipeline-details.html#cmdoption-pipeline-id

       oci goldengate pipeline pause-pipeline-default-pause-pipeline-details --pipeline-id $pipeline_id
