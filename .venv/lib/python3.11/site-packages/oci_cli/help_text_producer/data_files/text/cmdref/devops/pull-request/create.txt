...
The destination branch of the pull request. If not provided, default
branch will be used as the destination branch.
...
--reviewers [complex type]

Reviewers for this pull request.

This option is a JSON list with items of type CreateReviewerDetails.
For documentation on CreateReviewerDetails please see our API
reference: https://docs.oracle.com/en-
us/iaas/api/#/en/devops/20210630/datatypes/CreateReviewerDetails. This
...
--source-repository-id [text]

The OCID of the forked repository that will act as the source of the
changes to be included in the pull request against the parent
repository.
