...
=====
   ...
   oci apiaccesscontrol privileged-api-requests approve [OPTIONS]


Required Parameters
===================

--privileged-api-request-id [text]
...
--time-of-user-creation [datetime]

The time when access request is scheduled to be approved in RFC 3339
...
security policies before trying the examples.
       ...
       export privileged_api_request_id=<substitute-value-of-privileged_api_request_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/apiaccesscontrol/privileged-api-requests/approve.html#cmdoption-privileged-api-request-id

       oci apiaccesscontrol privileged-api-requests approve --privileged-api-request-id $privileged_api_request_id
