...
--configuration-override-details [complex type]
...
--step-override-details [complex type]

Array of step override details. Only Step Configuration is allowed to
be overridden.

This option is a JSON list with items of type
PipelineStepOverrideDetails.  For documentation on
PipelineStepOverrideDetails please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/datascience/20190101/data
types/PipelineStepOverrideDetails. This is a complex type whose value
