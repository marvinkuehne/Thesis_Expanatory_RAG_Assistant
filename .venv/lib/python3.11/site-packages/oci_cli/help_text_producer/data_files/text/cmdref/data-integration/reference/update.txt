...
Updates the application references. For example, to map a data asset
to a different target object.
...
--child-references [complex type]

The list of child references that also need to be updated.

This option is a JSON list with items of type ChildReferenceDetail.
For documentation on ChildReferenceDetail please see our API
reference: https://docs.oracle.com/en-us/iaas/api/#/en/dataintegratio
n/20200430/datatypes/ChildReferenceDetail. This is a complex type
...
A list of options such as *ignoreObjectOnError*. This is a complex
...
--target-object [complex type]

The new target object to reference. This can be of type *DataAsset*,
*Schema* or *Task*. In case of *DataAsset*, the child references can
be of type *Connection*. This is a complex type whose value must be
