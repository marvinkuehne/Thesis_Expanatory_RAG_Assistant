...
(For tenancies that support identity domains) Activates a deactivated
identity domain. You can only activate identity domains that your user
account is not a part of.

After you send the request, the *lifecycleDetails* of the identity
domain is set to ACTIVATING. When the operation completes, the
*lifecycleDetails* is set to null and the *lifecycleState* of the
identity domain is set to ACTIVE.
