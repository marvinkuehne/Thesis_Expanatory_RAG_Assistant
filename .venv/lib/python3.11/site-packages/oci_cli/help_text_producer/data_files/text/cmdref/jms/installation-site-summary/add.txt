...
--installation-sites [complex type]

The list of installation sites to add. This is a complex type whose
...
--post-installation-actions [complex type]

Optional list of post java installation actions

This option is a JSON list with items of type PostInstallationActions.
For documentation on PostInstallationActions please see our API
reference: https://docs.oracle.com/en-us/iaas/api/#/en/javamanagement
service/20210610/datatypes/PostInstallationActions. This is a complex
