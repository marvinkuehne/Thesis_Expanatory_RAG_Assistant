"update-stream-source-rtsp-source-details"
******************************************
...
=====
   ...
   oci ai-vision stream-source update-stream-source-rtsp-source-details [OPTIONS]
...
example parameters with your own.
       ...
       oci ai-vision stream-source update-stream-source-rtsp-source-details --generate-param-json-input stream-source-details-stream-network-access-details > stream-source-details-stream-network-access-details.json
...
security policies before trying the examples.
       ...
       export stream_source_details_camera_url=<substitute-value-of-stream_source_details_camera_url> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/ai-vision/stream-source/update-stream-source-rtsp-source-details.html#cmdoption-stream-source-details-camera-url
       ...
       oci ai-vision stream-source update-stream-source-rtsp-source-details --stream-source-details-camera-url $stream_source_details_camera_url --stream-source-details-stream-network-access-details file://stream-source-details-stream-network-access-details.json --stream-source-id $stream_source_id
