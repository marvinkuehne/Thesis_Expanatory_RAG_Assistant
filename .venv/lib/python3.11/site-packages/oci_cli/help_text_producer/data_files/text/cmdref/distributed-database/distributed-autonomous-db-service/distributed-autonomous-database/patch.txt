...
distributed autonomous database topology. In single patch operation,
multiple shards can be either added, or removed or updated.
Combination of inserts, update and remove in single operation is not
allowed.
...
=====
   ...
   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database patch [OPTIONS]
...
https://docs.oracle.com/en-us/iaas/api/#/en/distributedautonomousdbse
rvice/20250101/datatypes/PatchInstruction. This is a complex type
...
security policies before trying the examples.
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database patch --distributed-autonomous-database-id $distributed_autonomous_database_id
