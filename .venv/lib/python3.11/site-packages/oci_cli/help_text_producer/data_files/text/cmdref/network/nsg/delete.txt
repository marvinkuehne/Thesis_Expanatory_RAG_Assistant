...
Deletes the specified network security group. The group must not
contain any VNICs.

To get a list of the VNICs in a network security group, use
ListNetworkSecurityGroupVnics. Each returned NetworkSecurityGroupVnic
object contains both the OCID of the VNIC and the OCID of the VNIC’s
parent resource (for example, the Compute instance that the VNIC is
attached to).
