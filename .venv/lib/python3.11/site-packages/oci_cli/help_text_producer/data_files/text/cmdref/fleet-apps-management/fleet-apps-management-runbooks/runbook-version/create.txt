...
=====
   ...
   oci fleet-apps-management fleet-apps-management-runbooks runbook-version create [OPTIONS]
...
A set of tasks to execute in the runbook. This is a complex type whose
