...
Updates the properties of a master encryption key. Specifically, you
can update the *displayName*, *freeformTags*, and *definedTags*
properties. Furthermore, the key must be in an *ENABLED* or *CREATING*
state to be updated.
