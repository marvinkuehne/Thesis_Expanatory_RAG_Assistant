...
--cert-compartment-id [text]

The compartmentId of the leaf certificate.

--cert-key-algorithm [text]
...
The certificateAuthorityId of subordinate/intermediate certificate
authority.
...
--time-cert-validity-end [datetime]
...
--time-return-window-ends [datetime]
...
--time-return-window-starts [datetime]
