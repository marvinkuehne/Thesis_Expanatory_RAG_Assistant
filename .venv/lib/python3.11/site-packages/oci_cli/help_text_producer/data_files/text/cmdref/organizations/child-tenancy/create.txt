...
The home region to use for the child tenancy. This must be a region
where the parent tenancy is subscribed.
...
OCID of the subscription that needs to be assigned to the child
tenancy.
