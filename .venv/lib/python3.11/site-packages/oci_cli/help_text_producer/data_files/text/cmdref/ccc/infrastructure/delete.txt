...
Deletes a Compute Cloud@Customer infrastructure resource specified by
the resource OCID.
...
Deletes a Compute Cloud@Customer infrastructure resource specified by
the resource OCID. You can only delete an infrastructure that is not
connected to a Compute Cloud@Customer infrastructure in your data
center. An infrastructure that is not connected is in the REJECT
state.
...
Deletes an infrastructure without prompting for confirmation.Only an
infrastructure that is not connected to a Compute Cloud@Customer
infrastructure in your data center can be deleted.An infrastructure
that is not connected is in the REJECT state.
