...
=====
   ...
   oci ccc upgrade-schedule create [OPTIONS]
...
List of preferred times for Compute Cloud@Customer infrastructure to
be upgraded. This is a complex type whose value must be valid JSON.
...
security policies before trying the examples.
       ...
       oci ccc upgrade-schedule create --compartment-id $compartment_id --display-name $display_name --events file://events.json
...
Creates a new Compute Cloud@Customer upgrade schedule (event) in the
...
-------
    ...
    oci ccc upgrade-schedule create -c <compartment_OCID> --display-name 'TestUpgradeSchedule1' --events file://events.json
...

   {
    "data": {
         ...
         "events": [
              {
                   "description": "event1",
                   "name": "9cdd0116-2c04-4485-9089-aac5c869650e",
              ...
              {
                   "description": "event2",
                   "name": "1e10d6e2-22b0-474f-ade3-47099004bdbe",
         ...
         "time-updated": "2023-07-04T09:46:15.182000+00:00"
    }
   }
