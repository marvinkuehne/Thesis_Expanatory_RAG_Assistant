"create-fleet-dynamic-resource-selection"
*****************************************
...
=====
   ...
   oci fleet-apps-management fleet create-fleet-dynamic-resource-selection [OPTIONS]
...
--resource-selection-rule-selection-criteria [complex type]
...
AssociatedFleetCredentialDetails please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/fleetappsmanagement/20250
228/datatypes/AssociatedFleetCredentialDetails. This is a complex type
...
This option is a JSON list with items of type NotificationPreference.
For documentation on NotificationPreference please see our API
reference: https://docs.oracle.com/en-us/iaas/api/#/en/fleetappsmanag
ement/20250228/datatypes/NotificationPreference. This is a complex
...
This option is a JSON list with items of type
AssociatedFleetPropertyDetails.  For documentation on
AssociatedFleetPropertyDetails please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/fleetappsmanagement/20250
228/datatypes/AssociatedFleetPropertyDetails. This is a complex type
whose value must be valid JSON. The value can be provided as a string
on the command line or passed in as a file using the
file://path/to/file syntax.
...
AssociatedFleetResourceDetails please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/fleetappsmanagement/20250
228/datatypes/AssociatedFleetResourceDetails. This is a complex type
whose value must be valid JSON. The value can be provided as a string
on the command line or passed in as a file using the
file://path/to/file syntax.
...
example parameters with your own.
       ...
       oci fleet-apps-management fleet create-fleet-dynamic-resource-selection --generate-param-json-input resource-selection-rule-selection-criteria > resource-selection-rule-selection-criteria.json
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fleet-apps-management/fleet/create-fleet-dynamic-resource-selection.html#cmdoption-compartment-id
       export display_name=<substitute-value-of-display_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fleet-apps-management/fleet/create-fleet-dynamic-resource-selection.html#cmdoption-display-name

       oci fleet-apps-management fleet create-fleet-dynamic-resource-selection --compartment-id $compartment_id --display-name $display_name --resource-selection-rule-selection-criteria file://resource-selection-rule-selection-criteria.json
