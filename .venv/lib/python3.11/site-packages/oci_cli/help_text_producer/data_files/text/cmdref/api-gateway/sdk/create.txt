...
The string representing the target programming language for generating
the SDK.
...
us/iaas/api/#/en/apigateway/20190501/datatypes/AddResourceLockDetails.
This is a complex type whose value must be valid JSON. The value can
be provided as a string on the command line or passed in as a file
using the file://path/to/file syntax.
...
Additional optional configurations that can be passed to generate SDK
Api. The applicable parameters are listed under “parameters” when
“/sdkLanguageTypes” is called.
