...
The OCID of the subscription to delete.
...
Used for optimistic concurrency control. In the PUT or DELETE call for
...
--wait-for-state" PENDING "--wait-for-state" DELETED would return on
