...
A list of DR protection group members.  When updating members, this
list must contain all members being retained, including added and
updated members. The list must not contain deleted members.

This option is a JSON list with items of type
UpdateDrProtectionGroupMemberDetails.  For documentation on
UpdateDrProtectionGroupMemberDetails please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/disasterrecovery/20220125
/datatypes/UpdateDrProtectionGroupMemberDetails. This is a complex
