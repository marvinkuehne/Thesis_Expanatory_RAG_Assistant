"refresh-oracle-database-resource-principal-credential"
*******************************************************
...
=====
   ...
   oci dbtools identity refresh-oracle-database-resource-principal-credential [OPTIONS]
...
security policies before trying the examples.
       ...
       export identity_id=<substitute-value-of-identity_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/identity/refresh-oracle-database-resource-principal-credential.html#cmdoption-identity-id

       oci dbtools identity refresh-oracle-database-resource-principal-credential --identity-id $identity_id
