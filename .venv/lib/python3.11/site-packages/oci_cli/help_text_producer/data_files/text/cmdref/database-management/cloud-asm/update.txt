...
=====
   ...
   oci database-management cloud-asm update [OPTIONS]
...
security policies before trying the examples.
       ...
       export cloud_asm_id=<substitute-value-of-cloud_asm_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-management/cloud-asm/update.html#cmdoption-cloud-asm-id

       oci database-management cloud-asm update --cloud-asm-id $cloud_asm_id
