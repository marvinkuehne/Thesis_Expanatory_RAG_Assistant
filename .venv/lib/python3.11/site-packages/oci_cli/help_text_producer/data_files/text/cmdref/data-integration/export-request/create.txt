...
--are-references-included [boolean]

This field controls if the references will be exported along with the
objects
...
Filters for exported objects This is a complex type whose value must
...
--is-object-overwrite-enabled [boolean]

Flag to control whether to overwrite the object if it is already
present at the provided object storage location.
...
Field is used to specify which object keys to export This is a complex
...
--object-storage-region [text]

Region of the object storage (if using object storage of different
region)

--object-storage-tenancy-id [text]

Optional parameter to point to object storage tenancy (if using Object
Storage of different tenancy)
