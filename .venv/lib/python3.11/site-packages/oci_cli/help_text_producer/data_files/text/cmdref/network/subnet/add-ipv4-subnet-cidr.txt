...
=====
   ...
   oci network subnet add-ipv4-subnet-cidr [OPTIONS]
...
security policies before trying the examples.
       ...
       export ipv4_cidr_block=<substitute-value-of-ipv4_cidr_block> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/subnet/add-ipv4-subnet-cidr.html#cmdoption-ipv4-cidr-block
       ...
       oci network subnet add-ipv4-subnet-cidr --ipv4-cidr-block $ipv4_cidr_block --subnet-id $subnet_id
