...
**SCIM++ Properties:**  - type: string  - mutability: immutable  -
returned: default  - required: true
...
**SCIM++ Properties:**  - caseExact: false  - type: string  -
...
**SCIM++ Properties:**  - type: boolean  - mutability: readOnly  -
returned: default
...
A DateTime that specifies the date and time when the current database
password was set.

**SCIM++ Properties:**  - type: dateTime  - mutability: readOnly  -
returned: default
...
--mixed-db-password [text]

The user’s database password with mixed salt.

**SCIM++ Properties:**  - type: string  - mutability: readOnly  -
returned: default  - required: false
