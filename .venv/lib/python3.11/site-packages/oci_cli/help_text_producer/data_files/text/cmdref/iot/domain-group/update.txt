...
Updates the details of IoT domain group identified by the specified
OCID.
...
=====
   ...
   oci iot domain-group update [OPTIONS]
...
security policies before trying the examples.
       ...
       export iot_domain_group_id=<substitute-value-of-iot_domain_group_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iot/domain-group/update.html#cmdoption-iot-domain-group-id

       oci iot domain-group update --iot-domain-group-id $iot_domain_group_id
