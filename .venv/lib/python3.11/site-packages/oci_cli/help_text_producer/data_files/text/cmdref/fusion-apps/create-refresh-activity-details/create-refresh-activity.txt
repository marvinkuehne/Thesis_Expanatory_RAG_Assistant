...
--is-data-masking-opted [boolean]

Represents if the customer opted for Data Masking or not during
refreshActivity.
...
Current time the refresh activity is scheduled to start. An RFC3339
