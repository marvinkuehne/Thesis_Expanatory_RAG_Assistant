...
=====
   ...
   oci dif stack deploy-artifacts [OPTIONS]
...
This option is a JSON list with items of type AdbArtifactsDetail.  For
documentation on AdbArtifactsDetail please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/stack/20250830/datatypes/AdbArtifactsDetail. This is
...
This option is a JSON list with items of type DataflowArtifactsDetail.
For documentation on DataflowArtifactsDetail please see our API
reference: https://docs.oracle.com/en-
us/iaas/api/#/en/stack/20250830/datatypes/DataflowArtifactsDetail.
...
This option is a JSON list with items of type GgcsArtifactsDetail.
For documentation on GgcsArtifactsDetail please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/stack/20250830/datatypes/GgcsArtifactsDetail. This is
a complex type whose value must be valid JSON. The value can be
provided as a string on the command line or passed in as a file using
the file://path/to/file syntax.
...
documentation on OkeArtifactsDetail please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/stack/20250830/datatypes/OkeArtifactsDetail. This is
a complex type whose value must be valid JSON. The value can be
provided as a string on the command line or passed in as a file using
the file://path/to/file syntax.
...
documentation on OmkArtifactsDetail please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/stack/20250830/datatypes/OmkArtifactsDetail. This is
a complex type whose value must be valid JSON. The value can be
provided as a string on the command line or passed in as a file using
the file://path/to/file syntax.
...
security policies before trying the examples.
       ...
       oci dif stack deploy-artifacts --services $services --stack-id $stack_id --stack-templates $stack_templates
