...
Creates the peer target database under the primary target database in
Data Safe.
...
--database-details-infrastructure-type [text]
...
--database-details-db-system-id [text]

The OCID of the cloud database registered as a target database in Data
Safe.

--database-details-listener-port [integer]
...
--dataguard-association-id [text]

The OCID of the Data Guard Association resource in which the database
being registered is considered as peer database to the primary
database.
...
The display name of the peer target database in Data Safe. The name is
