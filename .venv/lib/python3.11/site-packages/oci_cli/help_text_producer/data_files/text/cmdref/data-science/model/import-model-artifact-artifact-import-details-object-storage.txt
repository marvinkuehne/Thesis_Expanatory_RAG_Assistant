...
--artifact-import-details-destination-bucket [text]

The name of the bucket. Avoid entering confidential information.

--artifact-import-details-destination-object-name [text]

The name of the object resulting from the copy operation.

--artifact-import-details-destination-region [text]

Region in which OSS bucket is present

--artifact-import-details-namespace [text]
