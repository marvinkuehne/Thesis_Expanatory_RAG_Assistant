...
--remediation-recipe-id [text]

The Oracle Cloud Identifier (OCID) of a Remediation Recipe, as a URL
path parameter.
...
--detect-configuration [complex type]
...
--is-run-triggered-on-kb-change [boolean]

Boolean indicating if a run should be automatically triggered once the
...
--scm-configuration [complex type]
...
--verify-configuration [complex type]
