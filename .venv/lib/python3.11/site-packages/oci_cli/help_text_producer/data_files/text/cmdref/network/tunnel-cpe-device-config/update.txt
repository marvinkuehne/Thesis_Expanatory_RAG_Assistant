...
Creates or updates the set of CPE configuration answers for the
specified tunnel. The answers correlate to the questions that are
specific to the CPE device type (see the *parameters* attribute of
...
This option is a JSON list with items of type CpeDeviceConfigAnswer.
For documentation on CpeDeviceConfigAnswer please see our API
reference: https://docs.oracle.com/en-
us/iaas/api/#/en/iaas/20160918/datatypes/CpeDeviceConfigAnswer. This
