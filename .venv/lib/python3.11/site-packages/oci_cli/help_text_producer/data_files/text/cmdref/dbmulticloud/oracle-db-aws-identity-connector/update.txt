...
Modifies the existing Oracle DB AWS Identity Connector resource for a
given OCID.
...
=====
   ...
   oci dbmulticloud oracle-db-aws-identity-connector update [OPTIONS]


Required Parameters
===================

--oracle-db-aws-identity-connector-id [text]
...
This option is a JSON list with items of type ServiceRoleDetail.  For
documentation on ServiceRoleDetail please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/dbmulticloudawsprovider/2
0240501/datatypes/ServiceRoleDetail. This is a complex type whose
...
security policies before trying the examples.
       ...
       export oracle_db_aws_identity_connector_id=<substitute-value-of-oracle_db_aws_identity_connector_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbmulticloud/oracle-db-aws-identity-connector/update.html#cmdoption-oracle-db-aws-identity-connector-id

       oci dbmulticloud oracle-db-aws-identity-connector update --oracle-db-aws-identity-connector-id $oracle_db_aws_identity_connector_id
