...
=====
   ...
   oci apiaccesscontrol privileged-api-control create [OPTIONS]
...
associated with a resource governed by this operator control. This is
...
by the operator is a part of privileged operation. This is a complex
...
security policies before trying the examples.
       ...
       oci apiaccesscontrol privileged-api-control create --approver-group-id-list file://approver-group-id-list.json --compartment-id $compartment_id --notification-topic-id $notification_topic_id --privileged-operation-list file://privileged-operation-list.json --resource-type $resource_type --resources file://resources.json
