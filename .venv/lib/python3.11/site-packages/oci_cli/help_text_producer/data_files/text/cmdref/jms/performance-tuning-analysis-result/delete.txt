...
Deletes only the metadata of the Performance Tuning Analysis result,
but the file remains in the object storage.
...
--performance-tuning-analysis-result-id [text]
