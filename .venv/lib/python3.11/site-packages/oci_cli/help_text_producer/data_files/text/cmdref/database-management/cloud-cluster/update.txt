...
=====
   ...
   oci database-management cloud-cluster update [OPTIONS]


Required Parameters
===================

--cloud-cluster-id [text]
...
security policies before trying the examples.
       ...
       export cloud_cluster_id=<substitute-value-of-cloud_cluster_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-management/cloud-cluster/update.html#cmdoption-cloud-cluster-id

       oci database-management cloud-cluster update --cloud-cluster-id $cloud_cluster_id
