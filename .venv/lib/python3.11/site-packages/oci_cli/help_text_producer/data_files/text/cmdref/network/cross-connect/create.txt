...
The name of the FastConnect interface where this cross-connect is
installed.
...
--oci-physical-device-name [text]

The name of the FastConnect device where this cross-connect is
installed.
