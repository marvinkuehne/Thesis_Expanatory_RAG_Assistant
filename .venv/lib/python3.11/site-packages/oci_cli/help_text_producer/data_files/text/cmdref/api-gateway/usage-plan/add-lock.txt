...
=====
   ...
   oci api-gateway usage-plan add-lock [OPTIONS]
...
security policies before trying the examples.
       ...
       export type=<substitute-value-of-type> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/api-gateway/usage-plan/add-lock.html#cmdoption-type
       ...
       oci api-gateway usage-plan add-lock --type $type --usage-plan-id $usage_plan_id
