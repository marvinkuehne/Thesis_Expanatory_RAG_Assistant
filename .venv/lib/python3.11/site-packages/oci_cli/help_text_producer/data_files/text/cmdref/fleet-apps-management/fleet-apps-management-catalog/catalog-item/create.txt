...
=====
   ...
   oci fleet-apps-management fleet-apps-management-catalog catalog-item create [OPTIONS]
...
--catalog-source-payload [complex type]
...
security policies before trying the examples.
       ...
       oci fleet-apps-management fleet-apps-management-catalog catalog-item create --compartment-id $compartment_id --config-source-type $config_source_type --description $description --display-name $display_name --package-type $package_type
