...
Deletes a batch task environment. All batch tasks associated with the
batch task environment must be canceled beforehand.


Usage
=====

   oci batch batch-task-environment delete [OPTIONS]
...
security policies before trying the examples.
       ...
       oci batch batch-task-environment delete --batch-task-environment-id $batch_task_environment_id
