...
This indicates if the question is selected by the Security Admin and
...
returned: always  - idcsCompositeKey: [locale]  - type: complex  -
...
This indicates if the question is a Custom Question added by the
Security Admin.
