...
BootVolumeReplicaDetails please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/iaas/20160918/datatypes/BootVolumeReplicaDetails.
...
for the boot volume cross region backups, which will be used in the
