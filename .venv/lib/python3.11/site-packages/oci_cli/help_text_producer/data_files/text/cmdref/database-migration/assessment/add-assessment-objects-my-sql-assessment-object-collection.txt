"add-assessment-objects-my-sql-assessment-object-collection"
************************************************************
...
=====
   ...
   oci database-migration assessment add-assessment-objects-my-sql-assessment-object-collection [OPTIONS]
...
example parameters with your own.
       ...
       oci database-migration assessment add-assessment-objects-my-sql-assessment-object-collection --generate-param-json-input items > items.json
...
security policies before trying the examples.
       ...
       oci database-migration assessment add-assessment-objects-my-sql-assessment-object-collection --assessment-id $assessment_id --items file://items.json
