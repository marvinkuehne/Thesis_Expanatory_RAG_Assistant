...
security policies before trying the examples.
       ...
       oci fleet-apps-management fleet-apps-management-maintenance-window maintenance-window create --compartment-id $compartment_id --duration $duration --time-schedule-start $time_schedule_start
