...
=====
   ...
   oci ai-vision stream-job create [OPTIONS]
...
security policies before trying the examples.
       ...
       oci ai-vision stream-job create --compartment-id $compartment_id --features file://features.json --stream-output-location file://stream-output-location.json --stream-source-id $stream_source_id
