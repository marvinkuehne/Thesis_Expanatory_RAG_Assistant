...
Update monitored resource by the given identifier OCID. Note that
“properties” object, if specified, will entirely replace the existing
object, as part this operation.
...
MonitoredResourceAliasCredential please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/stackmonitoring/20210330/
datatypes/MonitoredResourceAliasCredential. This is a complex type
...
MonitoredResourceCredential please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/stackmonitoring/20210330/
datatypes/MonitoredResourceCredential. This is a complex type whose
...
MonitoredResourceProperty please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/stackmonitoring/20210330/
datatypes/MonitoredResourceProperty. This is a complex type whose
value must be valid JSON. The value can be provided as a string on the
command line or passed in as a file using the file://path/to/file
syntax.
