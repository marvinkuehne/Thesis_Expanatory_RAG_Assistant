...
Moves the Oracle DB AWS Identity Connector resource into a different
...
=====
   ...
   oci dbmulticloud oracle-db-aws-identity-connector change-compartment [OPTIONS]
...
The OCID of the new compartment to contain the Oracle DB AWS Identity
Connector resource.
...
security policies before trying the examples.
       ...
       export oracle_db_aws_identity_connector_id=<substitute-value-of-oracle_db_aws_identity_connector_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbmulticloud/oracle-db-aws-identity-connector/change-compartment.html#cmdoption-oracle-db-aws-identity-connector-id

       oci dbmulticloud oracle-db-aws-identity-connector change-compartment --oracle-db-aws-identity-connector-id $oracle_db_aws_identity_connector_id
