...
Stages a new *DnssecKeyVersion* on the zone. Staging is a process that
generates a new “successor” key version that replaces an existing
“predecessor” key version. **Note:** A new key-signing key (KSK)
version is inert until you update the parent zone DS records.
...
--predecessor-dnssec-key-version-uuid [text]

The UUID of the *DnssecKeyVersion* for which a new successor should be
generated.
