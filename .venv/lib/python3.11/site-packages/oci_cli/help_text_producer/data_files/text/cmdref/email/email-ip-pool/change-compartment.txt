...
=====
   ...
   oci email email-ip-pool change-compartment [OPTIONS]
...
security policies before trying the examples.
       ...
       oci email email-ip-pool change-compartment --compartment-id $compartment_id --email-ip-pool-id $email_ip_pool_id
