...
Moves a CatalogItem into a different compartment within the same
...
=====
   ...
   oci fleet-apps-management fleet-apps-management-catalog catalog-item change-compartment [OPTIONS]
...
The OCID of the compartment to move the CatalogItem to
...
security policies before trying the examples.
       ...
       oci fleet-apps-management fleet-apps-management-catalog catalog-item change-compartment --catalog-item-id $catalog_item_id --compartment-id $compartment_id
