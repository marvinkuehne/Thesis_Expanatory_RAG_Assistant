...
Moves a Stack into a different compartment within the same tenancy.
...
=====
   ...
   oci dif stack change-compartment [OPTIONS]
...
The OCID of the compartment to move the Stack to.
...
security policies before trying the examples.
       ...
       oci dif stack change-compartment --compartment-id $compartment_id --stack-id $stack_id
