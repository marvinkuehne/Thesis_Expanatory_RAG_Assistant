...
Enables Database Management service for all the components of the
specified cloud DB system (except databases).


Usage
=====

   oci database-management cloud-db-system enable-cloud-db-system-database-management [OPTIONS]
...
security policies before trying the examples.
       ...
       export is_enabled=<substitute-value-of-is_enabled> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-management/cloud-db-system/enable-cloud-db-system-database-management.html#cmdoption-is-enabled
       ...
       oci database-management cloud-db-system enable-cloud-db-system-database-management --cloud-db-system-id $cloud_db_system_id --is-enabled $is_enabled
