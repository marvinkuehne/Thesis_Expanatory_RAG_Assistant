...
The authentication token to use when connecting to the Oracle
Streaming Service.
...
--event-sink-bot-ids [complex type]

The IDs of the Skills and Digital Assistants that the Channel is
routed to. This is a complex type whose value must be valid JSON. The
...
--outbound-message-topic [text]

The topic outbound messages are sent on.

--sasl-mechanism [text]

The SASL mechanmism to use when conecting to the Oracle Streaming
Service. See Oracle Streaming Service documentation for a list of
valid values.

--security-protocol [text]

The security protocol to use when conecting to the Oracle Streaming
Service. See Oracle Streaming Service documentation for a list of
valid values.
...
The stream pool OCI to use when connecting to the Oracle Streaming
Service.
