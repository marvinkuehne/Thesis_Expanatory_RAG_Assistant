...
=====
   ...
   oci email email-ip-pool remove [OPTIONS]
...
List of public IPs to REMOVE from the IpPool. After a public IP is
unassigned, it will be marked as AVAILABLE and can be assigned to
another IpPool. The last IP removed from the Pool will be deleted from
the IP Pool after 24 hours. This is a complex type whose value must be
...
example parameters with your own.
       ...
       oci email email-ip-pool remove --generate-param-json-input outbound-ips > outbound-ips.json
...
security policies before trying the examples.
       ...
       oci email email-ip-pool remove --email-ip-pool-id $email_ip_pool_id --outbound-ips file://outbound-ips.json
