...
=====
   ...
   oci dbmulticloud oracle-db-gcp-key-ring refresh [OPTIONS]
...
--oracle-db-gcp-connector-id [text]

The OCID of the Oracle DB GCP Connector resource.
...
security policies before trying the examples.
       ...
       oci dbmulticloud oracle-db-gcp-key-ring refresh --oracle-db-gcp-key-ring-id $oracle_db_gcp_key_ring_id
