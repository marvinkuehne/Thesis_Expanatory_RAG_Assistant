...
=====
   ...
   oci dbmulticloud oracle-db-gcp-identity-connector refresh [OPTIONS]
...
security policies before trying the examples.
       ...
       export oracle_db_gcp_identity_connector_id=<substitute-value-of-oracle_db_gcp_identity_connector_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbmulticloud/oracle-db-gcp-identity-connector/refresh.html#cmdoption-oracle-db-gcp-identity-connector-id

       oci dbmulticloud oracle-db-gcp-identity-connector refresh --oracle-db-gcp-identity-connector-id $oracle_db_gcp_identity_connector_id
