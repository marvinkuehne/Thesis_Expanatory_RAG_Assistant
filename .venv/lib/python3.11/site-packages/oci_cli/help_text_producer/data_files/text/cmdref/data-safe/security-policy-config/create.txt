...
=====
   ...
   oci data-safe security-policy-config create [OPTIONS]
...
security policies before trying the examples.
       ...
       oci data-safe security-policy-config create --compartment-id $compartment_id --security-policy-id $security_policy_id
