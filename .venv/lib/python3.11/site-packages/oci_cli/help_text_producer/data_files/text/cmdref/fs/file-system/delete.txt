...
a file system also deletes all of its snapshots.
...
--can-detach-child-file-system [boolean]

If the value is set to true, then the file system will be deleted by
detaching its child file system, turning the child file system into an
