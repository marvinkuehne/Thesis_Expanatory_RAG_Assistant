...
=====
   ...
   oci dbmulticloud oracle-db-aws-identity-connector delete [OPTIONS]
...
security policies before trying the examples.
       ...
       export oracle_db_aws_identity_connector_id=<substitute-value-of-oracle_db_aws_identity_connector_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbmulticloud/oracle-db-aws-identity-connector/delete.html#cmdoption-oracle-db-aws-identity-connector-id

       oci dbmulticloud oracle-db-aws-identity-connector delete --oracle-db-aws-identity-connector-id $oracle_db_aws_identity_connector_id
