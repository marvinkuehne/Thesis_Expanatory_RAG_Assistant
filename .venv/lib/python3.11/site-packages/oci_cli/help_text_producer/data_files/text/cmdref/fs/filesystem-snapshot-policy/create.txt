...
Creates a new file system snapshot policy in the specified compartment
and availability domain.

After you create a file system snapshot policy, you can associate it
with file systems.
...
The OCID of the compartment that contains the file system snapshot
policy.
...
The list of associated snapshot schedules. A maximum of 10 schedules
can be associated with a policy.

If using the CLI, provide the schedule as a list of JSON strings, with
the list wrapped in quotation marks, i.e. "`   --schedules '[{"timeZo
ne":"UTC","period":"DAILY","hourOfDay":18},{"timeZone":"UTC","period"
:"HOURLY"}]' `"

This option is a JSON list with items of type SnapshotSchedule.  For
documentation on SnapshotSchedule please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/filestorage/20171215/datatypes/SnapshotSchedule. This
