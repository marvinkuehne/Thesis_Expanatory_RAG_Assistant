...
Add new Global database services control(GDS CTL) node for the
...
=====
   ...
   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database add [OPTIONS]
...
The OCID of the subnet on which the Global database services
control(GDS CTL) node should be created.
...
security policies before trying the examples.
       ...
       export public_ssh_key=<substitute-value-of-public_ssh_key> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/distributed-database/distributed-autonomous-db-service/distributed-autonomous-database/add.html#cmdoption-public-ssh-key
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database add --distributed-autonomous-database-id $distributed_autonomous_database_id --public-ssh-key $public_ssh_key
