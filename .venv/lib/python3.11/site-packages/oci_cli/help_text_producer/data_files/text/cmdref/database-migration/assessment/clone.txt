...
=====
   ...
   oci database-migration assessment clone [OPTIONS]
...
--database-combination [text]

The combination of source and target databases participating in a
migration. Example: ORACLE means the migration is meant for migrating
...
example parameters with your own.
       ...
       oci database-migration assessment clone --generate-param-json-input source-database-connection > source-database-connection.json
       oci database-migration assessment clone --generate-param-json-input target-database-connection > target-database-connection.json
...
security policies before trying the examples.
       ...
       oci database-migration assessment clone --assessment-id $assessment_id --database-combination $database_combination --source-database-connection file://source-database-connection.json --target-database-connection file://target-database-connection.json
