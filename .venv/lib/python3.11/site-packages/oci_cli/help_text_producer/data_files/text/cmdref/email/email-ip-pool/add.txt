...
=====
   ...
   oci email email-ip-pool add [OPTIONS]
...
List of public IPs to ADD to the IpPool. Public IPs must be in the
AVAILABLE state to be assigned to the IpPool. This is a complex type
...
example parameters with your own.
       ...
       oci email email-ip-pool add --generate-param-json-input outbound-ips > outbound-ips.json
...
security policies before trying the examples.
       ...
       oci email email-ip-pool add --email-ip-pool-id $email_ip_pool_id --outbound-ips file://outbound-ips.json
