...
a resource governed by this operator control. This is a complex type
...
resource governed by this operator control. This is a complex type
whose value must be valid JSON. The value can be provided as a string
on the command line or passed in as a file using the
file://path/to/file syntax.
...
a resource governed by this operator control will be auto-approved if
the access request only contain operator actions in the pre-approved
...
This is the message that will be displayed to the operator users while
