...
The API extracts pii entities in text records. For each entity, its
type and confidence score (between 0 and 1) is returned.  It supports
...
List of documents to detect personal identification information. This
...
--masking [complex type]

Mask recognized PII entities with different modes.

This option is a JSON dictionary of type dict(str, PiiEntityMasking).
For documentation on PiiEntityMasking please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/aiservicelanguage/2022100
1/datatypes/PiiEntityMasking. This is a complex type whose value must
...
--profile-parameterconflict [complex type]
