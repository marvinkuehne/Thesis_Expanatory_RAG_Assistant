...
=====
   ...
   oci fleet-apps-management fleet-apps-management-runbooks runbook change-compartment [OPTIONS]
...
The OCID of the compartment to move the Planner to.
...
security policies before trying the examples.
       ...
       oci fleet-apps-management fleet-apps-management-runbooks runbook change-compartment --compartment-id $compartment_id --runbook-id $runbook_id
