...
Creates a new dashboard group using the details provided in request
body.
...
group resource in regions other than the home region, you won’t be
able to view those resources in the Console. Therefore, creating
...
The OCID of the compartment containing the dashboard group.
...
A short description of the dashboard group. It can be changed. Avoid
