"perform-assessor-action-download-sql"
**************************************
...
=====
   ...
   oci database-migration assessment perform-assessor-action-download-sql [OPTIONS]
...
security policies before trying the examples.
       ...
       export assessor_name=<substitute-value-of-assessor_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-migration/assessment/perform-assessor-action-download-sql.html#cmdoption-assessor-name
       ...
       oci database-migration assessment perform-assessor-action-download-sql --assessment-id $assessment_id --assessor-name $assessor_name
