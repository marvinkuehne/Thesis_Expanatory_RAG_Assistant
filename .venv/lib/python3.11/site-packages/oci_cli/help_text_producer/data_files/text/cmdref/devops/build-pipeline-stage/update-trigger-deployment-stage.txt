...
--is-pass-all-parameters-enabled [boolean]

A boolean flag that specifies whether all the parameters must be
passed when the deployment is triggered.
