...
Moves the Oracle DB Azure Connector resource into a different
...
=====
   ...
   oci dbmulticloud oracle-db-azure-connector change-compartment [OPTIONS]
...
The OCID of the new compartment to contain the Oracle DB Azure
Connector resource.
...
security policies before trying the examples.
       ...
       oci dbmulticloud oracle-db-azure-connector change-compartment --oracle-db-azure-connector-id $oracle_db_azure_connector_id
