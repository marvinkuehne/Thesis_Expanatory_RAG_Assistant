...
Updates the specified security attribute namespace. You can’t update
the namespace name.

Updating *isRetired* to ‘true’ retires the namespace and all the
security attributes in the namespace. Reactivating a namespace
(changing *isRetired* from ‘true’ to ‘false’) does not reactivate
security attributes. To reactivate the security attributes, you must
reactivate each one individually *after* you reactivate the namespace,
using UpdateSecurityAttribute. For more information about retiring
security attribute namespaces, see Managing Security Attribute
Namespaces.

You can’t add a namespace with the same name as a retired namespace in
the same tenancy.
...
The description you assign to the security attribute namespace to help
you identify it.
...
Indicates whether the security attribute namespace is retired. See
