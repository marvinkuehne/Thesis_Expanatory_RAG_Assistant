...
User provided reason for accepting or modifying this finding if they
choose to do so.
...
--time-valid-until [datetime]

The time until which the change in severity (deferred / modified) got
the given finding is valid.
