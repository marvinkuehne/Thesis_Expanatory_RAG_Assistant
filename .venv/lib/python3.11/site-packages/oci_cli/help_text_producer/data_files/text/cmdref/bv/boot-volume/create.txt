...
this, –source-boot-volume-id or –source-volume-replica-id but not all.
...
specify either this, –boot-volume-backup-id or –source-volume-replica-
id but not all.
...
restored on the newly created boot volume. You can specify either
this, –source-boot-volume-id or –boot-volume-backup-id –but not all.
