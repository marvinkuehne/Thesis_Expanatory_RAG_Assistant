...
Moves the Oracle DB Azure Blob Container resource into a different
...
=====
   ...
   oci dbmulticloud oracle-db-azure-blob-container change-compartment [OPTIONS]
...
he OCID of the compartment that contains the Oracle DB Azure Blob
Container resource.
...
security policies before trying the examples.
       ...
       oci dbmulticloud oracle-db-azure-blob-container change-compartment --oracle-db-azure-blob-container-id $oracle_db_azure_blob_container_id
