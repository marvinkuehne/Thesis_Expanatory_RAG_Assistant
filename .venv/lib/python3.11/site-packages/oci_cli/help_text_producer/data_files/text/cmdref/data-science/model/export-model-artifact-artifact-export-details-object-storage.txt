...
--artifact-export-details-namespace [text]

The Object Storage namespace used for the request.

--artifact-export-details-source-bucket [text]

The name of the bucket. Avoid entering confidential information.

--artifact-export-details-source-object-name [text]

The name of the object resulting from the copy operation.

--artifact-export-details-source-region [text]
