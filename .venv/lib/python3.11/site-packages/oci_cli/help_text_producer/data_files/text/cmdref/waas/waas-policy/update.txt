...
Updates the details of a WAAS policy, including origins and tags. Only
the fields specified in the request body will be updated; all other
properties will remain unchanged. To update platform provided
resources such as *GoodBots*, *ProtectionRules*, and *ThreatFeeds*,
first retrieve the list of available resources with the related list
operation such as *GetThreatFeeds* or *GetProtectionRules*. The
returned list will contain objects with *key* properties that can be
used to update the resource during the *UpdateWaasPolicy* request.
...
An array of additional domains protected by this WAAS policy. This is
...
documentation on OriginGroup please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/waas/20181116/datatypes/OriginGroup. This is a
...
https://docs.oracle.com/en-
us/iaas/api/#/en/waas/20181116/datatypes/Origin. This is a complex
