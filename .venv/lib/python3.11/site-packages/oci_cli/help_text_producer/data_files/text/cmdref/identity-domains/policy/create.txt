...
The Groovy script that is run instead of the policy, if the policy
type allows the policy to be a Groovy script.
...
This option is a JSON list with items of type PolicyRules.  For
documentation on PolicyRules please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/identitydomains/v1/datatypes/PolicyRules. This is a
complex type whose value must be valid JSON. The value can be provided
as a string on the command line or passed in as a file using the
file://path/to/file syntax.
...
--urnietfparamsscimschemasoracleidcsextensionociconsolesignonpolicyconsent-policy [complex type]
