...
A friendly name for the environment family. The name must contain only
letters, numbers, dashes, and underscores. Can be changed later.

--family-maintenance-policy [complex type]
...
--subscription-ids [complex type]

The list of the IDs of the applications subscriptions that are
associated with the environment family. This is a complex type whose
