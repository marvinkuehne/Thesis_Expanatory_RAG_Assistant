...
=====
   ...
   oci fleet-apps-management fleet-apps-management-runbooks runbook export [OPTIONS]
...
example parameters with your own.
       ...
       oci fleet-apps-management fleet-apps-management-runbooks runbook export --generate-param-json-input content-destination > content-destination.json
...
security policies before trying the examples.
       ...
       oci fleet-apps-management fleet-apps-management-runbooks runbook export --content-destination file://content-destination.json --runbook-id $runbook_id
