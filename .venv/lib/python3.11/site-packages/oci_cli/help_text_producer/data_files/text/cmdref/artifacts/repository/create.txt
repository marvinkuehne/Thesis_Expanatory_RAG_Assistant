...
Whether to make the repository immutable. The artifacts of an
immutable repository cannot be overwritten.
...
A user-friendly display name for the repository. If not present, will
be auto-generated. It can be modified later. Avoid entering
...
--wait-for-state" AVAILABLE "--wait-for-state" DELETED would return on
