...
=====
   ...
   oci dbmulticloud oracle-db-aws-key create [OPTIONS]
...
The OCID of the compartment that contains Oracle DB AWS Key resource.
...
AWS Key resource’s properties. This is a complex type whose value must
...
security policies before trying the examples.
       ...
       oci dbmulticloud oracle-db-aws-key create --compartment-id $compartment_id --display-name $display_name --oracle-db-connector-id $oracle_db_connector_id
