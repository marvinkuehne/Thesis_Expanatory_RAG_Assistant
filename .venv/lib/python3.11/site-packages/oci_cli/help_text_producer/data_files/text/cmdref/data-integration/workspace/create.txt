...
Creates a new Data Integration Workspace ready for performing data
integration.
...
A user-friendly display name for the workspace. Does not have to be
unique, and can be modified. Avoid entering confidential information.

--is-private-network [boolean]

Specifies whether the private network connection is enabled or
disabled.
...
--dns-server-zone [text]

The DNS zone of the custom DNS to use to resolve names.

--endpoint-compartment-id [text]

DCMS PRivate Endpoint Compartment Identifier

--endpoint-id [text]

DCMS Private Endpoint ID associated with workspace if the pvt
...
--workspace-properties [complex type]
