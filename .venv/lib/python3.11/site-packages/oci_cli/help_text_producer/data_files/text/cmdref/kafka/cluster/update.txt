...
=====
   ...
   oci kafka cluster update [OPTIONS]
...
This option is a JSON list with items of type SubnetSet.  For
documentation on SubnetSet please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/kafkacluster/20240901/datatypes/SubnetSet. This is a
...
security policies before trying the examples.
       ...
       export kafka_cluster_id=<substitute-value-of-kafka_cluster_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/kafka/cluster/update.html#cmdoption-kafka-cluster-id

       oci kafka cluster update --kafka-cluster-id $kafka_cluster_id
