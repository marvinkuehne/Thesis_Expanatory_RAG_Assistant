...
Updates the specified boot volume’s display name, defined tags, and
free-form tags.
...
The list of boot volume replicas that this boot volume will be updated
to have in the specified destination availability domains.
