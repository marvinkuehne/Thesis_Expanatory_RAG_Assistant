...
--storage-details-is-regionally-durable [boolean]

Specifies if the block volume used for the database system is regional
or AD-local. If not specified, it will be set to false. If
*isRegionallyDurable* is set to true, *availabilityDomain* should not
be specified. If *isRegionallyDurable* is set to false,
...
--storage-details-availability-domain [text]

Specifies the availability domain of AD-local storage. If
*isRegionallyDurable* is set to true, *availabilityDomain* should not
be specified. If *isRegionallyDurable* is set to false,
*availabilityDomain* must be specified.

--storage-details-iops [integer]

Guaranteed input/output storage requests per second (IOPS) available
