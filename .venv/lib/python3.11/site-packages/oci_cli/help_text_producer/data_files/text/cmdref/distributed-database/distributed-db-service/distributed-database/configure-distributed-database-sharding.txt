...
Once all components of Globally distributed database are provisioned,
and signed GSM certificates are successfully uploaded, this api shall
be invoked to configure sharding on the Globally distributed database.
Note that this ‘ConfigureSharding’ API also needs to be invoked after
successfully adding a new shard to the Globally distributed database
...
topology of the Globally distributed database.


Usage
=====

   oci distributed-database distributed-db-service distributed-database configure-distributed-database-sharding [OPTIONS]
...
security policies before trying the examples.
       ...
       oci distributed-database distributed-db-service distributed-database configure-distributed-database-sharding --distributed-database-id $distributed_database_id
