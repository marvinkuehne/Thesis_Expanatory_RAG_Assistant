...
Creates a new JavaDownloadToken in the tenancy with specified
attributes. Ensure that you review the license terms before token
generation. Visit the <a
href=”https://www.oracle.com/java/technologies/downloads”/>Oracle Java
Downloads</a> page to understand the license terms of the Java version
for which you are generating a token. By generating a token, you agree
to the associated license terms. See <a
href=”https://www.oracle.com/cis/java/technologies/javase/jdk-
faqs.html”>Oracle JDK Licensing - FAQs</a> for detailed information.
...
The license type(s) associated with the JavaDownloadToken. This is a
