...
Accepts the UserDefinedFunction definition in the request payload and
creates a UserDefinedFunction validation.
...
Generated key that can be used in API calls to identify user defined
function. On scenarios where reference to the user defined function is
...
--signatures [complex type]

An array of function signature.

This option is a JSON list with items of type FunctionSignature.  For
documentation on FunctionSignature please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/dataintegration/20200430/datatypes/FunctionSignature.
This is a complex type whose value must be valid JSON. The value can
be provided as a string on the command line or passed in as a file
using the file://path/to/file syntax.
