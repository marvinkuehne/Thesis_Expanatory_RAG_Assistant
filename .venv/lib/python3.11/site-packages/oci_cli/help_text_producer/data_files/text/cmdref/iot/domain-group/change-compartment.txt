...
Moves an IoT domain group to a different compartment within the same
...
=====
   ...
   oci iot domain-group change-compartment [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iot/domain-group/change-compartment.html#cmdoption-compartment-id
       export iot_domain_group_id=<substitute-value-of-iot_domain_group_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iot/domain-group/change-compartment.html#cmdoption-iot-domain-group-id

       oci iot domain-group change-compartment --compartment-id $compartment_id --iot-domain-group-id $iot_domain_group_id
