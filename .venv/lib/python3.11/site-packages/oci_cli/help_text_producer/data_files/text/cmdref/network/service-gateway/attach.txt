...
Adds the specified Service to the list of enabled *Service* objects
for the specified gateway. You must also set up a route rule with the
*cidrBlock* of the *Service* as the rule’s destination and the service
gateway as the rule’s target. See Route Table.

**Note:** The *AttachServiceId* operation is an easy way to add an
individual *Service* to the service gateway. Compare it with
