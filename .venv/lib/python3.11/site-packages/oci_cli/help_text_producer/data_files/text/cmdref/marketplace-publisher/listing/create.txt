...
You must also specify a *name* for the listing and cannot be updated
later.

You must also specify a *packageType* for the listing. Allowed values
are CONTAINER_IMAGE and HELM_CHART

After you send your request, the new object’s *lifecycleState* will be
CREATING. Before using the object, first make sure its
...
Accepted values are:
   ...
   CONTAINER_IMAGE, HELM_CHART, MACHINE_IMAGE, NONE, STACK
