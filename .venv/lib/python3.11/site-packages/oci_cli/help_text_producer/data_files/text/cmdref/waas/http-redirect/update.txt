...
Only the fields specified in the request body will be updated; all
...
The user-friendly name of the HTTP Redirect. The name can be changed
...
The response code returned for the redirect to the client. For more
information, see RFC 7231.

--target [complex type]

The redirect target object including all the redirect data. This is a
