...
=====
   ...
   oci dbmulticloud oracle-db-azure-blob-container create [OPTIONS]


Required Parameters
===================

--azure-storage-account-name [text]

Azure Storage account name.

--azure-storage-container-name [text]
...
--private-endpoint-dns-alias [text]

Private endpoint’s DNS alias.

--private-endpoint-ip-address [text]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbmulticloud/oracle-db-azure-blob-container/create.html#cmdoption-compartment-id
       export display_name=<substitute-value-of-display_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbmulticloud/oracle-db-azure-blob-container/create.html#cmdoption-display-name

       oci dbmulticloud oracle-db-azure-blob-container create --azure-storage-account-name $azure_storage_account_name --azure-storage-container-name $azure_storage_container_name --compartment-id $compartment_id --display-name $display_name
