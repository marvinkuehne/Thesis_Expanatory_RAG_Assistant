...
Moves a PrivilegedApiControl into a different compartment within the
...
=====
   ...
   oci apiaccesscontrol privileged-api-control change-compartment [OPTIONS]
...
The OCID of the compartment to move the PrivilegedApiControl to.
...
security policies before trying the examples.
       ...
       oci apiaccesscontrol privileged-api-control change-compartment --compartment-id $compartment_id --privileged-api-control-id $privileged_api_control_id
