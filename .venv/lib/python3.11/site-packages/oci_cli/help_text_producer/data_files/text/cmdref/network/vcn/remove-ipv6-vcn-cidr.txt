...
This field is not required and should only be specified when removing
ULA or private IPv6 prefix or an IPv6 GUA assigned by Oracle or
BYOIPv6 prefix from a VCN’s IPv6 address space. See`IPv6 Addresses <h
ttps://docs.cloud.oracle.com/iaas/Content/Network/Concepts/ipv6.htm>`
__.
