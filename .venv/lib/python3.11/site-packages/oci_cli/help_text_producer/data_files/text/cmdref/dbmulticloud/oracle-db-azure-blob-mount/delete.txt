...
Unmounts Oracle DB Azure Blob Mount resource from an Exadata VM
cluster in Oracle Exadata Database Service on Dedicated Infrastructure
(ExaDB-D) and deletes Oracle DB Azure Blob Mount resource.


Usage
=====

   oci dbmulticloud oracle-db-azure-blob-mount delete [OPTIONS]
...
security policies before trying the examples.
       ...
       oci dbmulticloud oracle-db-azure-blob-mount delete --oracle-db-azure-blob-mount-id $oracle_db_azure_blob_mount_id
