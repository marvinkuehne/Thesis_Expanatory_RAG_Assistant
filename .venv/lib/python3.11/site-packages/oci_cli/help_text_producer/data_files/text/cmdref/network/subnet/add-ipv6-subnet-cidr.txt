...
This field is not required and should only be specified when adding an
IPv6 prefix to a subnet’s IPv6 address space. See`IPv6 Addresses <htt
ps://docs.cloud.oracle.com/iaas/Content/Network/Concepts/ipv6.htm>`__.
