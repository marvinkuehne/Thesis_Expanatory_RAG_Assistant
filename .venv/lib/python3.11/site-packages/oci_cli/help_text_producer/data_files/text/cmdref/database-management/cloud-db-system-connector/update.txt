...
=====
   ...
   oci database-management cloud-db-system-connector update [OPTIONS]
...
security policies before trying the examples.
       ...
       oci database-management cloud-db-system-connector update --cloud-db-system-connector-id $cloud_db_system_connector_id --connector-type $connector_type
