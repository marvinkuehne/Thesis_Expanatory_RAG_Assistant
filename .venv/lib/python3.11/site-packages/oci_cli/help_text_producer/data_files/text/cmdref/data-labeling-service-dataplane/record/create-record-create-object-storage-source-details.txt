...
The OCID of the compartment for the record. This is tied to the
dataset. It is not changeable on the record itself.
...
The name is automatically assigned by the service. It is unique and
immutable.

--source-details-relative-path [text]

The path relative to the prefix specified in the dataset source
details (file name).
