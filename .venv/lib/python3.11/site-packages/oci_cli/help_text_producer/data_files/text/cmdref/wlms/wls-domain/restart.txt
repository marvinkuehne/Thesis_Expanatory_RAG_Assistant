...
Restarts all the servers in the WebLogic domains. Servers that are
...
=====
   ...
   oci wlms wls-domain restart [OPTIONS]
...
Force shutdown of the servers if they have not shutdown after a period
of time. The timeout can be configured in the WebLogic domain
configuration.
...
security policies before trying the examples.
       ...
       export wls_domain_id=<substitute-value-of-wls_domain_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/wlms/wls-domain/restart.html#cmdoption-wls-domain-id

       oci wlms wls-domain restart --wls-domain-id $wls_domain_id
