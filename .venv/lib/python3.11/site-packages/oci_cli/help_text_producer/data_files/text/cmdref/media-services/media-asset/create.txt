...
Display name for the Media Asset. Does not have to be unique. Avoid
...
--media-asset-tags [complex type]

list of tags for the MediaAsset.

This option is a JSON list with items of type MediaAssetTag.  For
documentation on MediaAssetTag please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/mediaservices/20211101/datatypes/MediaAssetTag. This
is a complex type whose value must be valid JSON. The value can be
provided as a string on the command line or passed in as a file using
the file://path/to/file syntax.
...
This option is a JSON list with items of type Metadata.  For
documentation on Metadata please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/mediaservices/20211101/datatypes/Metadata. This is a
...
--segment-range-end-index [integer]

The end index for video segment files.

--segment-range-start-index [integer]
