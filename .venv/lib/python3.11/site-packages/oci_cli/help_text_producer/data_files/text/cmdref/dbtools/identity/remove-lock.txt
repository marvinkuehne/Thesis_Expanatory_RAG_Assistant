...
Removes a lock from a Database Tools identity resource.


Usage
=====

   oci dbtools identity remove-lock [OPTIONS]
...
security policies before trying the examples.
       ...
       export identity_id=<substitute-value-of-identity_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/identity/remove-lock.html#cmdoption-identity-id
       export type=<substitute-value-of-type> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/identity/remove-lock.html#cmdoption-type

       oci dbtools identity remove-lock --identity-id $identity_id --type $type
