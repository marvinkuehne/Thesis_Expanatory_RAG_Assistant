...
Clones a CatalogItem into a different compartment within the same
...
=====
   ...
   oci fleet-apps-management fleet-apps-management-catalog catalog-item clone [OPTIONS]
...
security policies before trying the examples.
       ...
       oci fleet-apps-management fleet-apps-management-catalog catalog-item clone --catalog-item-id $catalog_item_id --compartment-id $compartment_id
