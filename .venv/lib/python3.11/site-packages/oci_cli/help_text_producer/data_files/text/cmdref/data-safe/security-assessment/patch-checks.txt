...
Patches one or more checks in the specified template type security
assessment. Use it to add or delete checks. To add check, use
CreateCheckDetails as the patch value.


Usage
=====

   oci data-safe security-assessment patch-checks [OPTIONS]
...
us/iaas/api/#/en/datasafe/20181201/datatypes/PatchInstruction. This is
...
security policies before trying the examples.
       ...
       oci data-safe security-assessment patch-checks --security-assessment-id $security_assessment_id
