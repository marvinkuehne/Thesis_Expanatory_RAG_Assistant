...
--is-applicable-to-all-resources [boolean]

A boolean flag that decides if all resources within the fleet should
...
Resource OCIDS to be included for validation. This is a complex type
