...
=====
   ...
   oci database-management cloud-db-node update [OPTIONS]


Required Parameters
===================

--cloud-db-node-id [text]
...
security policies before trying the examples.
       ...
       export cloud_db_node_id=<substitute-value-of-cloud_db_node_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-management/cloud-db-node/update.html#cmdoption-cloud-db-node-id

       oci database-management cloud-db-node update --cloud-db-node-id $cloud_db_node_id
