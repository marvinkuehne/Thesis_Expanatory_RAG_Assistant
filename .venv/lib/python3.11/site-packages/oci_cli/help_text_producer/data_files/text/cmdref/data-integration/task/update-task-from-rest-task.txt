...
Updates a specific task. For example, you can update the task
description or move the task to a different folder by changing the
*aggregatorKey* to a different folder in the registry.
...
Generated key that can be used in API calls to identify task. On
scenarios where reference to the task is needed, a value can be passed
in create.
...
The REST invocation pattern to use. ASYNC_OCI_WORKREQUEST is being
deprecated as well as cancelEndpoint/MethodType.

Accepted values are:

   ASYNC_GENERIC, ASYNC_OCI_WORKREQUEST, SYNCHRONOUS

--apiendpoint [complex type]
...
--cancel-rest-config [complex type]
...
--execute-rest-config [complex type]
...
Headers data for the request. This is a complex type whose value must
...
documentation on InputPort please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/dataintegration/20200430/datatypes/InputPort. This is
...
JSON data for payload body. This property is deprecated, use
ExecuteRestCallConfig’s payload config param instead.

--method-type [text]

The REST method to use. This property is deprecated, use
ExecuteRestCallConfig’s methodType property instead.
...
documentation on OutputPort please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/dataintegration/20200430/datatypes/OutputPort. This
...
documentation on Parameter please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/dataintegration/20200430/datatypes/Parameter. This is
a complex type whose value must be valid JSON. The value can be
provided as a string on the command line or passed in as a file using
the file://path/to/file syntax.
...
--poll-rest-call-config [complex type]
...
--typed-expressions [complex type]

List of typed expressions.

This option is a JSON list with items of type TypedExpression.  For
documentation on TypedExpression please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/dataintegration/20200430/datatypes/TypedExpression.
This is a complex type whose value must be valid JSON. The value can
be provided as a string on the command line or passed in as a file
using the file://path/to/file syntax.
