...
Duration of the maintenance window. Specify how long the maintenance
window remains open.
...
Does the maintenenace window cause outage? An outage indicates whether
a maintenance window can consider operations that require downtime. It
means a period when the application is not accessible.
...
Recurrence rule specification if maintenance window recurring. Specify
the frequency of running the maintenance window.

--time-schedule-start [datetime]

Specify the date and time of the day that the maintenance window
starts.
...
security policies before trying the examples.
       ...
       export time_schedule_start=<substitute-value-of-time_schedule_start> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fleet-apps-management/fleet-apps-management-maintenance-window/maintenance-window/create.html#cmdoption-time-schedule-start

       maintenance_window_id=$(oci fleet-apps-management fleet-apps-management-maintenance-window maintenance-window create --compartment-id $compartment_id --duration $duration --time-schedule-start $time_schedule_start --query data.id --raw-output)
