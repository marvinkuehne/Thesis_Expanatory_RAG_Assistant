...
Move a streamSource from one compartment to another. When provided,
If-Match is checked against the ETag values of the resource.


Usage
=====

   oci ai-vision stream-source change-compartment [OPTIONS]
...
The OCID of the compartment into which the streamSource should be
moved.
...
security policies before trying the examples.
       ...
       oci ai-vision stream-source change-compartment --compartment-id $compartment_id --stream-source-id $stream_source_id
