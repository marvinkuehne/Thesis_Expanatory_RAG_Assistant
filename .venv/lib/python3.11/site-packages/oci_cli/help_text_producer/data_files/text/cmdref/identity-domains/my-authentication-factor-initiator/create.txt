...
Auth Factor represents the type of multi-factor authentication channel
for which the request has been initiated.
...
MyAuthenticationFactorInitiatorAdditionalAttributes.  For
documentation on MyAuthenticationFactorInitiatorAdditionalAttributes
please see our API reference: https://docs.oracle.com/en-us/iaas/api/
#/en/identitydomains/v1/datatypes/MyAuthenticationFactorInitiatorAddi
tionalAttributes. This is a complex type whose value must be valid
...
**SCIM++ Properties:**  - caseExact: true  - idcsSearchable: false  -
multiValued: false  - mutability: readWrite  - required: false  -
returned: default  - type: string  - uniqueness: none  - idcsPii: true
