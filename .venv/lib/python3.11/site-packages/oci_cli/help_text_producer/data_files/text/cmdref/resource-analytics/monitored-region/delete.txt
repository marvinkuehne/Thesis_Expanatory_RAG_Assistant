...
=====
   ...
   oci resource-analytics monitored-region delete [OPTIONS]


Required Parameters
===================

--monitored-region-id [text]
...
security policies before trying the examples.
       ...
       export region_id=<substitute-value-of-region_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/resource-analytics/monitored-region/create.html#cmdoption-region-id
       ...
       monitored_region_id=$(oci resource-analytics monitored-region create --region-id $region_id --resource-analytics-instance-id $resource_analytics_instance_id --query data.id --raw-output)

       oci resource-analytics monitored-region delete --monitored-region-id $monitored_region_id
