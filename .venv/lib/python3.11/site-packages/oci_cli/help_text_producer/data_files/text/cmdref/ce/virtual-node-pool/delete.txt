...
--is-force-deletion-after-override-grace-duration-vnp [boolean]

If the underlying virtual node should be force deleted if all the pods
are not evicted in the evictionGraceDuration.
...
--override-eviction-grace-duration-vnp [text]

Duration after which SKE will give up eviction of the pods on the
node. PT0M will indicate you want to delete the virtual node without
cordon and drain. Default PT60M, Min PT0M, Max: PT60M. Format ISO 8601
e.g PT30M
