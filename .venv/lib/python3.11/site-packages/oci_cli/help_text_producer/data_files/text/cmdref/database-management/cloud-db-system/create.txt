...
=====
   ...
   oci database-management cloud-db-system create [OPTIONS]
...
--database-management-config [complex type]
...
--stack-monitoring-config [complex type]
...
security policies before trying the examples.
       ...
       oci database-management cloud-db-system create --compartment-id $compartment_id --db-system-discovery-id $db_system_discovery_id
