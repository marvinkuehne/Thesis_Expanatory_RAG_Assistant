...
An updated connection state of the Compute Cloud@Customer
infrastructure.
...
OCID for the network subnet that is used to communicate with Compute
...
Updates a Compute Cloud@Customer infrastructure display name by the
specified infrastructure OCID. Avoid entering confidential
information.
...
-------
    ...
    oci ccc infrastructure update --infrastructure-id <infrastructure_OCID> --display-name 'TestInfrastructureUpgrade1'
...
Updates a Compute Cloud@Customer infrastructure by the specified OCID
with an upgrade schedule.
