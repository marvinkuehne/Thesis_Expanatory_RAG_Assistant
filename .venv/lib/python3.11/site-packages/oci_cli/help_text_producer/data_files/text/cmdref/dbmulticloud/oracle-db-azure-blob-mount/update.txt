...
=====
   ...
   oci dbmulticloud oracle-db-azure-blob-mount update [OPTIONS]


Required Parameters
===================

--oracle-db-azure-blob-mount-id [text]
...
The OCID of the compartment that contains Oracle DB Azure Blob Mount
resource.
...
The OCID of the Oracle DB Azure Blob Container resource that contains
Oracle DB Azure Blob Mount resource.

--oracle-db-azure-connector-id [text]

The OCID of the Oracle DB Azure Connector resource that contains
Oracle DB Azure Blob Mount resource.
...
security policies before trying the examples.
       ...
       oracle_db_azure_blob_mount_id=$(oci dbmulticloud oracle-db-azure-blob-mount create --compartment-id $compartment_id --display-name $display_name --oracle-db-azure-blob-container-id $oracle_db_azure_blob_container_id --oracle-db-azure-connector-id $oracle_db_azure_connector_id --query data.id --raw-output)

       oci dbmulticloud oracle-db-azure-blob-mount update --oracle-db-azure-blob-mount-id $oracle_db_azure_blob_mount_id
