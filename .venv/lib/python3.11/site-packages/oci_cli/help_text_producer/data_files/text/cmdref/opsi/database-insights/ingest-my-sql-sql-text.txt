...
The SqlText endpoint takes in a JSON payload, persists it in Operation
Insights ingest pipeline. Either databaseId or id must be specified.
Disclaimer: SQL text being uploaded explicitly via APIs is already
masked. All sensitive literals contained in the sqlFullText column are
masked prior to ingestion.


Usage
=====

   oci opsi database-insights ingest-my-sql-sql-text [OPTIONS]
...
This option is a JSON list with items of type MySqlSqlText.  For
documentation on MySqlSqlText please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/operationsinsights/20200630/datatypes/MySqlSqlText.
...
security policies before trying the examples.
       ...
       oci opsi database-insights ingest-my-sql-sql-text
