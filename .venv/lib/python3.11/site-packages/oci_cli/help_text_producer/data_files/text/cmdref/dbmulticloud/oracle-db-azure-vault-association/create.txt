...
=====
   ...
   oci dbmulticloud oracle-db-azure-vault-association create [OPTIONS]
...
security policies before trying the examples.
       ...
       oci dbmulticloud oracle-db-azure-vault-association create --compartment-id $compartment_id --display-name $display_name --oracle-db-azure-connector-id $oracle_db_azure_connector_id --oracle-db-azure-vault-id $oracle_db_azure_vault_id
