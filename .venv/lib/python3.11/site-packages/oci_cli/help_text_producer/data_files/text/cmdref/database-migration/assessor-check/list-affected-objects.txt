...
=====
   ...
   oci database-migration assessor-check list-affected-objects [OPTIONS]
...
security policies before trying the examples.
       ...
       export assessor_name=<substitute-value-of-assessor_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-migration/assessor-check/list-affected-objects.html#cmdoption-assessor-name
       export check_name=<substitute-value-of-check_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-migration/assessor-check/list-affected-objects.html#cmdoption-check-name
       ...
       oci database-migration assessor-check list-affected-objects --assessment-id $assessment_id --assessor-name $assessor_name --check-name $check_name
