...
Updates a target (Target resource) identified by targetId, using
parameters passed in an UpdateTargetDetails resource.
...
UpdateTargetDetectorRecipe.  For documentation on
UpdateTargetDetectorRecipe please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/cloudguard/20200131/datat
ypes/UpdateTargetDetectorRecipe. This is a complex type whose value
...
This option is a JSON list with items of type
UpdateTargetResponderRecipe.  For documentation on
UpdateTargetResponderRecipe please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/cloudguard/20200131/datat
ypes/UpdateTargetResponderRecipe. This is a complex type whose value
must be valid JSON. The value can be provided as a string on the
command line or passed in as a file using the file://path/to/file
syntax.
