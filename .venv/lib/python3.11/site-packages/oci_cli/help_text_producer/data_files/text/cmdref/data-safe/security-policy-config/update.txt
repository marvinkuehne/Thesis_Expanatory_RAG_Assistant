...
=====
   ...
   oci data-safe security-policy-config update [OPTIONS]
...
The display name of the security policy configuration. The name does
not have to be unique, and it is changeable.

--firewall-config [complex type]
...
--unified-audit-policy-config [complex type]
...
security policies before trying the examples.
       ...
       oci data-safe security-policy-config update --security-policy-config-id $security_policy_config_id
