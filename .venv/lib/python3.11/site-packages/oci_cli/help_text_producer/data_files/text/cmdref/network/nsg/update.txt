...
To add a VNIC to the group *when you create the VNIC*, specify the
NSG’s OCID during creation. For example, see the *nsgIds* attribute in
CreateVnicDetails.

To add or remove security rules from the group, use
AddNetworkSecurityGroupSecurityRules or
