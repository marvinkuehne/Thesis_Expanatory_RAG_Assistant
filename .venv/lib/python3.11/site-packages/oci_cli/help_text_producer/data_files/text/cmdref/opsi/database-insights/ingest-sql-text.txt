...
Disclaimer: SQL text being uploaded explicitly via APIs is not masked.
Any sensitive literals contained in the sqlFullText column should be
...
This option is a JSON list with items of type SqlText.  For
documentation on SqlText please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/operationsinsights/20200630/datatypes/SqlText. This
