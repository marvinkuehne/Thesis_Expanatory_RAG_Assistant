...
Attaches an instance to an instance pool. For information about the
prerequisites that an instance must meet before you can attach it to a
pool, see Attaching an Instance to an Instance Pool.
...
--wait-for-state" ATTACHING "--wait-for-state" TERMINATION_PROCEED
