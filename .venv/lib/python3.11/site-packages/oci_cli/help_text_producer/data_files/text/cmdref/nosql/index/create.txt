...
A set of keys for a secondary index. This is a complex type whose
...
If true, the operation completes successfully even when the index
exists.  Otherwise, an attempt to create an index that already exists
