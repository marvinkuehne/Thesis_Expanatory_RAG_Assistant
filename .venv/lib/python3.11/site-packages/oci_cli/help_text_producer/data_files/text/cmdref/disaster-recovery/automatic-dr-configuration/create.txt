...
=====
   ...
   oci disaster-recovery automatic-dr-configuration create [OPTIONS]
...
The OCID of the DR protection group to which this Automatic DR
...
A list of members for Automatic DR configuration. This is a complex
...
security policies before trying the examples.
       ...
       oci disaster-recovery automatic-dr-configuration create --display-name $display_name --dr-protection-group-id $dr_protection_group_id --members file://members.json
