...
=====
   ...
   oci database-migration assessment perform-assessor-check-action [OPTIONS]
...
Array of user defined details for check action. This is a complex type
...
example parameters with your own.
       ...
       oci database-migration assessment perform-assessor-check-action --generate-param-json-input items > items.json
...
security policies before trying the examples.
       ...
       export assessor_check_action=<substitute-value-of-assessor_check_action> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-migration/assessment/perform-assessor-check-action.html#cmdoption-assessor-check-action
       export assessor_name=<substitute-value-of-assessor_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-migration/assessment/perform-assessor-check-action.html#cmdoption-assessor-name
       export check_name=<substitute-value-of-check_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-migration/assessment/perform-assessor-check-action.html#cmdoption-check-name
       ...
       oci database-migration assessment perform-assessor-check-action --assessment-id $assessment_id --assessor-check-action $assessor_check_action --assessor-name $assessor_name --check-name $check_name --items file://items.json
