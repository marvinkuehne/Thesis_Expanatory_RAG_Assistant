...
Deletes an existing OCI Cache User based on the OCI cache user unique
ID (OCID).
...
=====
   ...
   oci redis oci-cache-user oci-cache-user delete [OPTIONS]
...
security policies before trying the examples.
       ...
       export oci_cache_user_id=<substitute-value-of-oci_cache_user_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/redis/oci-cache-user/oci-cache-user/delete.html#cmdoption-oci-cache-user-id

       oci redis oci-cache-user oci-cache-user delete --oci-cache-user-id $oci_cache_user_id
