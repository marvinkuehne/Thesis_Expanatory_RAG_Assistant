...
=====
   ...
   oci dbmulticloud oracle-db-aws-identity-connector refresh [OPTIONS]
...
security policies before trying the examples.
       ...
       export oracle_db_aws_identity_connector_id=<substitute-value-of-oracle_db_aws_identity_connector_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbmulticloud/oracle-db-aws-identity-connector/refresh.html#cmdoption-oracle-db-aws-identity-connector-id

       oci dbmulticloud oracle-db-aws-identity-connector refresh --oracle-db-aws-identity-connector-id $oracle_db_aws_identity_connector_id
