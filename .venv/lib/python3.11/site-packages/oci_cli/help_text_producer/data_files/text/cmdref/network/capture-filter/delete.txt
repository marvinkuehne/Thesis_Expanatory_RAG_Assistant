...
Deletes the specified VTAP capture filter. This is an asynchronous
operation. The VTAP capture filter’s *lifecycleState* will change to
TERMINATING temporarily until the VTAP capture filter is completely
removed.
