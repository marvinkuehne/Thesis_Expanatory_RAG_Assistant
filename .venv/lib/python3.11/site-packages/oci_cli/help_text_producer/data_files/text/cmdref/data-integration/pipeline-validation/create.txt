...
Generated key that can be used in API calls to identify pipeline. On
scenarios where reference to the pipeline is needed, a value can be
passed in create.
...
documentation on FlowNode please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/dataintegration/20200430/datatypes/FlowNode. This is
...
A list of parameters for the pipeline, this allows certain aspects of
the pipeline to be configured when the pipeline is executed.
...
The list of variables required in pipeline, variables can be used to
store values that can be used as inputs to tasks in the pipeline.

This option is a JSON list with items of type Variable.  For
documentation on Variable please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/dataintegration/20200430/datatypes/Variable. This is
a complex type whose value must be valid JSON. The value can be
provided as a string on the command line or passed in as a file using
the file://path/to/file syntax.
