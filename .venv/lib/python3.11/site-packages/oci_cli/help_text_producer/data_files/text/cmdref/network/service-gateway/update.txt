...
The OCID of the route table the service gateway will use. For
information about why you would associate a route table with a service
gateway, see Transit Routing: Private Access to Oracle Services.

--services [complex type]

List of all the *Service* objects you want enabled on this service
gateway. Sending an empty list means you want to disable all services.
Omitting this parameter entirely keeps the existing list of services
intact.

You can also enable or disable a particular *Service* by using
AttachServiceId or DetachServiceId.
...
service gateway as the rule’s target. See Route Table.
...
us/iaas/api/#/en/iaas/20160918/datatypes/ServiceIdRequestDetails. This
