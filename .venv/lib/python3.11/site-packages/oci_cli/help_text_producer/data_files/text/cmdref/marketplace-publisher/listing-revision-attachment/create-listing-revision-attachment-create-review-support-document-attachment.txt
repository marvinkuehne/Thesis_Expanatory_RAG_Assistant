"create-listing-revision-attachment-create-review-support-document-attachment"
******************************************************************************
...
=====
   ...
   oci marketplace-publisher listing-revision-attachment create-listing-revision-attachment-create-review-support-document-attachment [OPTIONS]
...
security policies before trying the examples.
       ...
       export document_name=<substitute-value-of-document_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/marketplace-publisher/listing-revision-attachment/create-listing-revision-attachment-create-review-support-document-attachment.html#cmdoption-document-name
       export template_code=<substitute-value-of-template_code> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/marketplace-publisher/listing-revision-attachment/create-listing-revision-attachment-create-review-support-document-attachment.html#cmdoption-template-code
       ...
       oci marketplace-publisher listing-revision-attachment create-listing-revision-attachment-create-review-support-document-attachment --document-name $document_name --listing-revision-id $listing_revision_id --template-code $template_code
