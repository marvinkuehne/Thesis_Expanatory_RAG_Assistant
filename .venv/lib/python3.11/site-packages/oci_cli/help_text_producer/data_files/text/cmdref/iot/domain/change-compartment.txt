...
Moves an IoT domain to a different compartment within the same
...
=====
   ...
   oci iot domain change-compartment [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iot/domain/change-compartment.html#cmdoption-compartment-id
       export iot_domain_id=<substitute-value-of-iot_domain_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iot/domain/change-compartment.html#cmdoption-iot-domain-id

       oci iot domain change-compartment --compartment-id $compartment_id --iot-domain-id $iot_domain_id
