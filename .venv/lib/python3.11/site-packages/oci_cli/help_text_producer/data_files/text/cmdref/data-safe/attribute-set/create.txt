...
=====
   ...
   oci data-safe attribute-set create [OPTIONS]
...
The list of values in an attribute set This is a complex type whose
...
The display name of the attribute set. The name is unique and
changeable.
...
security policies before trying the examples.
       ...
       oci data-safe attribute-set create --attribute-set-type $attribute_set_type --attribute-set-values file://attribute-set-values.json --compartment-id $compartment_id --display-name $display_name
