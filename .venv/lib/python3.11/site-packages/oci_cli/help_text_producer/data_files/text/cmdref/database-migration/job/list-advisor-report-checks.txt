...
=====
   ...
   oci database-migration job list-advisor-report-checks [OPTIONS]
...
security policies before trying the examples.
       ...
       export job_id=<substitute-value-of-job_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-migration/job/list-advisor-report-checks.html#cmdoption-job-id

       oci database-migration job list-advisor-report-checks --job-id $job_id
