...
--add-osns [complex type]

new OSNs to add

This option is a JSON list with items of type CreateOsnDetails.  For
documentation on CreateOsnDetails please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/blockchainplatform/201910
10/datatypes/CreateOsnDetails. This is a complex type whose value must
...
--add-peers [complex type]

new Peers to add

This option is a JSON list with items of type CreatePeerDetails.  For
documentation on CreatePeerDetails please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/blockchainplatform/201910
10/datatypes/CreatePeerDetails. This is a complex type whose value
...
--modify-peers [complex type]

modify ocpu allocation to existing Peers

This option is a JSON list with items of type ModifyPeerDetails.  For
documentation on ModifyPeerDetails please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/blockchainplatform/201910
10/datatypes/ModifyPeerDetails. This is a complex type whose value
must be valid JSON. The value can be provided as a string on the
command line or passed in as a file using the file://path/to/file
syntax.
...
--remove-osns [complex type]

OSN id list to remove This is a complex type whose value must be valid
...
--remove-peers [complex type]

Peer id list to remove This is a complex type whose value must be
