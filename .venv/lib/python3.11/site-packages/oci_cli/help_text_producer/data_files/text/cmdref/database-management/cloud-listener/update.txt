...
=====
   ...
   oci database-management cloud-listener update [OPTIONS]


Required Parameters
===================

--cloud-listener-id [text]
...
security policies before trying the examples.
       ...
       export cloud_listener_id=<substitute-value-of-cloud_listener_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-management/cloud-listener/update.html#cmdoption-cloud-listener-id

       oci database-management cloud-listener update --cloud-listener-id $cloud_listener_id
