...
security policies before trying the examples.
       ...
       export ca_bundle_id=<substitute-value-of-ca_bundle_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/distributed-database/distributed-autonomous-db-service/distributed-autonomous-database/generate-distributed-autonomous-database-gsm-certificate-signing-request.html#cmdoption-ca-bundle-id
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database generate-distributed-autonomous-database-gsm-certificate-signing-request --ca-bundle-id $ca_bundle_id --distributed-autonomous-database-id $distributed_autonomous_database_id
