...
=====
   ...
   oci database-migration assessment perform-assessor-action [OPTIONS]
...
Array of name-value details for assessor action. This is a complex
...
example parameters with your own.
       ...
       oci database-migration assessment perform-assessor-action --generate-param-json-input items > items.json
...
security policies before trying the examples.
       ...
       export assessor_action=<substitute-value-of-assessor_action> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-migration/assessment/perform-assessor-action.html#cmdoption-assessor-action
       export assessor_name=<substitute-value-of-assessor_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-migration/assessment/perform-assessor-action.html#cmdoption-assessor-name
       ...
       oci database-migration assessment perform-assessor-action --assessment-id $assessment_id --assessor-action $assessor_action --assessor-name $assessor_name --items file://items.json
