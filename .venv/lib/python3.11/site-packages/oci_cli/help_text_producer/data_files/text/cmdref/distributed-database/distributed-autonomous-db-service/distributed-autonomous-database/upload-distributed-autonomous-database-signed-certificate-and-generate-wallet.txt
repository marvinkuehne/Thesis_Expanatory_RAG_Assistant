"upload-distributed-autonomous-database-signed-certificate-and-generate-wallet"
*******************************************************************************
...
Upload the CA signed certificate to the GSM instances and generate
wallets for GSM instances of the Globally distributed autonomous
database. Customer shall provide the CA signed certificate key details
by adding the certificate in request body.


Usage
=====

   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database upload-distributed-autonomous-database-signed-certificate-and-generate-wallet [OPTIONS]


Required Parameters
===================

--ca-signed-certificate [text]
...
security policies before trying the examples.
       ...
       export ca_signed_certificate=<substitute-value-of-ca_signed_certificate> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/distributed-database/distributed-autonomous-db-service/distributed-autonomous-database/upload-distributed-autonomous-database-signed-certificate-and-generate-wallet.html#cmdoption-ca-signed-certificate
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database upload-distributed-autonomous-database-signed-certificate-and-generate-wallet --ca-signed-certificate $ca_signed_certificate --distributed-autonomous-database-id $distributed_autonomous_database_id
