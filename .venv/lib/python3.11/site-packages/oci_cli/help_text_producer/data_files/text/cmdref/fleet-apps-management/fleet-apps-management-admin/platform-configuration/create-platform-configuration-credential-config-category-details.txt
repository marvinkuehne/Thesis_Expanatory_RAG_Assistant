"create-platform-configuration-credential-config-category-details"
******************************************************************
...
security policies before trying the examples.
       ...
       export display_name=<substitute-value-of-display_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fleet-apps-management/fleet-apps-management-admin/platform-configuration/create-platform-configuration-credential-config-category-details.html#cmdoption-display-name

       oci fleet-apps-management fleet-apps-management-admin platform-configuration create-platform-configuration-credential-config-category-details --compartment-id $compartment_id --display-name $display_name
