...
Starts all the servers in the WebLogic domain. Servers that are
already started are ignored.


Usage
=====

   oci wlms wls-domain start [OPTIONS]
...
security policies before trying the examples.
       ...
       export wls_domain_id=<substitute-value-of-wls_domain_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/wlms/wls-domain/start.html#cmdoption-wls-domain-id

       oci wlms wls-domain start --wls-domain-id $wls_domain_id
