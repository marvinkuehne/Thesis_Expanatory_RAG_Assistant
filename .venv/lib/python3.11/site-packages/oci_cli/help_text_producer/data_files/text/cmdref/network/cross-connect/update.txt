...
A reference name or identifier for the physical fiber connection this
cross-connect uses.
...
Set to true to activate the cross-connect. You activate it after the
physical cabling is complete, and you’ve confirmed the cross-connect’s
light levels are good and your side of the interface is up. Activation
indicates to Oracle that the physical connection is ready.
...
--wait-for-state" PENDING_CUSTOMER "--wait-for-state" TERMINATED would
