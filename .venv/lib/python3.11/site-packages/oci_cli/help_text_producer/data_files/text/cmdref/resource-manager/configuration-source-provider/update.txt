...
The type of configuration source provider. The
*BITBUCKET_CLOUD_USERNAME_APPPASSWORD* type corresponds to Bitbucket
Cloud. The *BITBUCKET_SERVER_ACCESS_TOKEN* type corresponds to
Bitbucket Server. The *GITLAB_ACCESS_TOKEN* type corresponds to
GitLab. The *GITHUB_ACCESS_TOKEN* type corresponds to GitHub.
