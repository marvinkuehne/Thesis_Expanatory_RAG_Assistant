...
=====
   ...
   oci database-management cloud-db-home update [OPTIONS]
...
security policies before trying the examples.
       ...
       export cloud_db_home_id=<substitute-value-of-cloud_db_home_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-management/cloud-db-home/update.html#cmdoption-cloud-db-home-id

       oci database-management cloud-db-home update --cloud-db-home-id $cloud_db_home_id
