...
instance. To monitor the status of the job, take the *opc-work-
request-id* response header value and use it to call *GET
...
Retain the ODA instance being deleted for the given number of days
before hard-delete/purge.
