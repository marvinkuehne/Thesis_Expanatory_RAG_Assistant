...
Alter the table identified by tableNameOrId, changing schema, limits,
or tags
...
The OCID of the table’s current compartment.  Required if the
tableNameOrId path parameter is a table name. Optional if
tableNameOrId is an OCID.  If tableNameOrId is an OCID, and
compartmentId is supplied, the latter must match the identified
