...
Database connection string. Required for database-connection-type
CUSTOM_JDBC

--database-authentication-details [complex type]
...
--database-service-name [text]

Service name of the database. Required for database-connection-type
CLOUD_WALLET
...
--database-wallet [text]

The database wallet configuration zip file path. Required for
database-connection-type CLOUD_WALLET
