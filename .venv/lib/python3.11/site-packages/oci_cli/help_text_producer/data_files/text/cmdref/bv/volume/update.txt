...
Updates the specified volume’s display name. Avoid entering
...
The list of block volume replicas that this volume will be updated to
have in the specified destination availability domains.
...
The size to resize the volume to in GBs. Has to be larger than the
current size.
