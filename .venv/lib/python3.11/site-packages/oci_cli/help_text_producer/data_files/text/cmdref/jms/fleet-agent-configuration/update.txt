...
--agent-polling-interval-in-minutes [integer]
...
--is-collecting-usernames-enabled [boolean]
...
JMS scan for JRE installations.)

--jut-processing-frequency [integer]

The frequency (in minutes) of Java Usage Tracker processing. (That is,
how often should JMS process data from the Java Usage Tracker.)

--linux-configuration [complex type]
...
--mac-os-configuration [complex type]
...
--windows-configuration [complex type]
...
--work-request-validity-period-in-days [integer]
