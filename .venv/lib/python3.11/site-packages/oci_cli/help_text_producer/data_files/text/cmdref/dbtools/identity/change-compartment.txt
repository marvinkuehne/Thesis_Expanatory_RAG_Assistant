...
Moves the specified Database Tools identity to a different compartment
in the same tenancy. For information about moving resources between
...
=====
   ...
   oci dbtools identity change-compartment [OPTIONS]
...
The OCID of the compartment to move the Database Tools identity to.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/identity/change-compartment.html#cmdoption-compartment-id
       export identity_id=<substitute-value-of-identity_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/identity/change-compartment.html#cmdoption-identity-id

       oci dbtools identity change-compartment --compartment-id $compartment_id --identity-id $identity_id
