...
A collection of entitlements to assign to the newly created usage
plan. This is a complex type whose value must be valid JSON. The value
...
us/iaas/api/#/en/usageplans/20190501/datatypes/AddResourceLockDetails.
This is a complex type whose value must be valid JSON. The value can
be provided as a string on the command line or passed in as a file
using the file://path/to/file syntax.
