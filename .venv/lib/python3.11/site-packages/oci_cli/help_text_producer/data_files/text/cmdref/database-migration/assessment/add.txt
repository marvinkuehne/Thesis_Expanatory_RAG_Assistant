...
=====
   ...
   oci database-migration assessment add [OPTIONS]
...
security policies before trying the examples.
       ...
       oci database-migration assessment add --assessment-id $assessment_id --database-combination $database_combination
