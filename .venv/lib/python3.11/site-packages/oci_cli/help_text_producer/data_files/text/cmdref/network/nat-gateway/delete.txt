...
Deletes the specified NAT gateway. The NAT gateway does not have to be
disabled, but there must not be a route rule that lists the NAT
gateway as a target.

This is an asynchronous operation. The NAT gateway’s *lifecycleState*
will change to TERMINATING temporarily until the NAT gateway is
completely removed.
