...
*displayName*, *freeformTags*, and *definedTags* properties. When the
notebook session is in the INACTIVE lifecycle state, you can update
*notebookSessionConfigurationDetails* and change *shape*, *subnetId*,
and *blockStorageSizeInGBs*. Changes to the
*notebookSessionConfigurationDetails* take effect the next time the
*ActivateNotebookSession* action is invoked on the notebook session
resource.
