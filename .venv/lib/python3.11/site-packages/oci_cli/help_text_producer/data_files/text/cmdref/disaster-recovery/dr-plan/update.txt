...
--plan-groups [complex type]

An ordered list of groups in a DR plan.

This option is a JSON list with items of type
UpdateDrPlanGroupDetails.  For documentation on
UpdateDrPlanGroupDetails please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/disasterrecovery/20220125
/datatypes/UpdateDrPlanGroupDetails. This is a complex type whose
