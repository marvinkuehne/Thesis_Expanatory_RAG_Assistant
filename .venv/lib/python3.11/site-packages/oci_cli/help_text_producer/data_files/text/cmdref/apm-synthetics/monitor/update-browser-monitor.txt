...
Dns settings. This is a complex type whose value must be valid JSON.
...
--is-default-snapshot-enabled [boolean]
...
Details of the network configuration. This is a complex type whose
...
Expected HTTP response codes. For status code range, set values such
as 2xx, 3xx. This is a complex type whose value must be valid JSON.
The value can be provided as a string on the command line or passed in
as a file using the file://path/to/file syntax.
