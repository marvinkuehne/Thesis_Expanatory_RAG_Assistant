...
User provided key and value pair configuration, which is assigned
through constants or parameter. This is a complex type whose value
...
--function-environment-id [text]

Function environment OCID.

--function-timeout-in-seconds [integer]
