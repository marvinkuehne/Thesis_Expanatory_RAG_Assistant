...
Updates the Exadata storage server connector specified by
...
--external-exadata-storage-connector-id [text]
...
The unique string of the connection. For example, “https://<storage-
server-name>/MS/RESTService/”.

--connector-name [text]

The name of the Exadata storage server connector.

--credential-info [complex type]
