...
=====
   ...
   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database delete [OPTIONS]
...
security policies before trying the examples.
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database delete --distributed-autonomous-database-id $distributed_autonomous_database_id
