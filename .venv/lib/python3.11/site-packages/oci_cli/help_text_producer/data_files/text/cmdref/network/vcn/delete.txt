...
Deletes the specified VCN. The VCN must be completely empty and have
no attached gateways. This is an asynchronous operation.

A deleted VCN’s *lifecycleState* changes to TERMINATING and then
TERMINATED temporarily until the VCN is completely removed. A
completely removed VCN does not appear in the results of a *ListVcns*
operation and can’t be used in a *GetVcn* operation.
