...
=====
   ...
   oci opsi database-insights update-macs-managed-autonomous-database-insight [OPTIONS]
...
security policies before trying the examples.
       ...
       export database_insight_id=<substitute-value-of-database_insight_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/opsi/database-insights/update-macs-managed-autonomous-database-insight.html#cmdoption-database-insight-id

       oci opsi database-insights update-macs-managed-autonomous-database-insight --database-insight-id $database_insight_id
