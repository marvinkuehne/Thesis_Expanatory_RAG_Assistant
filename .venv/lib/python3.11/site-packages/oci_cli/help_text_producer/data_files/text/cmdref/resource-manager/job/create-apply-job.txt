...
--execution-plan-strategy [text]

The OCID of a plan job, for use when specifying *FROM_PLAN_JOB_ID* as
the *executionPlanStrategy*.
...
Specifies the source of the execution plan to apply. Use
*AUTO_APPROVED* to run the job without an execution plan.

--freeform-tags [complex type]

Free-form tags associated with this resource. Each tag is a key-value
...
--job-operation-details-is-provider-upgrade-required [boolean]
...
--terraform-advanced-options [complex type]

Specifies advanced options for Terraform commands. These options are
not necessary for normal usage of Terraform.
