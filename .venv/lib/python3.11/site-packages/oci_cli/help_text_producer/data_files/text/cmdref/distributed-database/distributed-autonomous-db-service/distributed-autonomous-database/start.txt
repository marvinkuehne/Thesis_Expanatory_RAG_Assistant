...
Start the shards, catalog and GSMs of Globally distributed autonomous
database.
...
=====
   ...
   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database start [OPTIONS]
...
security policies before trying the examples.
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database start --distributed-autonomous-database-id $distributed_autonomous_database_id
