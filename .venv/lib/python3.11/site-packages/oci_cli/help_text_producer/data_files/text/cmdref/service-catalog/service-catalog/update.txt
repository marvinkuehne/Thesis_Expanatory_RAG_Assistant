...
security policies before trying the examples.
       ...
       export status=<substitute-value-of-status> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/service-catalog/service-catalog/update.html#cmdoption-status
       ...
       oci service-catalog service-catalog update --display-name $display_name --service-catalog-id $service_catalog_id --status $status
