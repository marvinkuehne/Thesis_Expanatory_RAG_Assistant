...
Updates the configuration of the Globally distributed autonomous
database.
...
=====
   ...
   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database update [OPTIONS]
...
security policies before trying the examples.
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database update --distributed-autonomous-database-id $distributed_autonomous_database_id
