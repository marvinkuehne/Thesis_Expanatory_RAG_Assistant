...
*description*, *freeformTags*, and *definedTags* properties.
...
--custom-metadata-list [complex type]
...
us/iaas/api/#/en/datascience/20190101/datatypes/Metadata. This is a
...
--defined-metadata-list [complex type]
...
--model-version-set-id [text]

The OCID of the model version set that the model is associated to.

--retention-setting [complex type]
...
The version label can add an additional description of the lifecycle
state of the model or the application using/training the model.
