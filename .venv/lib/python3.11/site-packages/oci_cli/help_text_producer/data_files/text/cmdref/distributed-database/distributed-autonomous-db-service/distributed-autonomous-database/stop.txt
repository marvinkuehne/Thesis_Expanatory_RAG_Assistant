...
Stop the shards, catalog and GSM instances for the Globally
...
=====
   ...
   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database stop [OPTIONS]
...
security policies before trying the examples.
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database stop --distributed-autonomous-database-id $distributed_autonomous_database_id
