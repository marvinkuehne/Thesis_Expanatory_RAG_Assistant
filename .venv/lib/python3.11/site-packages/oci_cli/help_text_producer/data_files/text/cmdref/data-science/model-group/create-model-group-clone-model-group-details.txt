...
=====
   ...
   oci data-science model-group create-model-group-clone-model-group-details [OPTIONS]
...
--model-group-clone-source-details [complex type]
...
example parameters with your own.
       ...
       oci data-science model-group create-model-group-clone-model-group-details --generate-param-json-input model-group-clone-source-details > model-group-clone-source-details.json
...
security policies before trying the examples.
       ...
       oci data-science model-group create-model-group-clone-model-group-details --compartment-id $compartment_id --model-group-clone-source-details file://model-group-clone-source-details.json --project-id $project_id
