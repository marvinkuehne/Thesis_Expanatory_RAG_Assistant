...
Publish the specified version of the runbook. The specified version of
the runbook becomes acitve when it is published.Only active versions
of runbook can be used in execution.
...
security policies before trying the examples.
       ...
       export runbook_version_id=<substitute-value-of-runbook_version_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fleet-apps-management/fleet-apps-management-runbooks/runbook/publish.html#cmdoption-runbook-version-id
       ...
       oci fleet-apps-management fleet-apps-management-runbooks runbook publish --runbook-id $runbook_id --runbook-version-id $runbook_version_id
