...
defined in referenced MlApplication.
...
Switches lifecycle state of MlApplicationInstance from INACTIVE to
ACTIVE (true value) or vice versa (false value).
...
solution for a given ML problem (ML Application) used for the given
instance.
