...
Disables Database Management service for all the components of the
...
=====
   ...
   oci database-management cloud-db-system disable-cloud-db-system-database-management [OPTIONS]
...
security policies before trying the examples.
       ...
       oci database-management cloud-db-system disable-cloud-db-system-database-management --cloud-db-system-id $cloud_db_system_id
