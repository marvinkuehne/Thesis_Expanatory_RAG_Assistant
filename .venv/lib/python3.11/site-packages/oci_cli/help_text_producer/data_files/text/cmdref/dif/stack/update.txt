...
This option is a JSON list with items of type AdbUpdateDetail.  For
documentation on AdbUpdateDetail please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/stack/20250830/datatypes/AdbUpdateDetail. This is a
...
DATAFLOW details if dataflow is included in the services to be
updated.

This option is a JSON list with items of type DataflowUpdateDetail.
For documentation on DataflowUpdateDetail please see our API
reference: https://docs.oracle.com/en-
us/iaas/api/#/en/stack/20250830/datatypes/DataflowUpdateDetail. This
...
This option is a JSON list with items of type GenAiUpdateDetail.  For
documentation on GenAiUpdateDetail please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/stack/20250830/datatypes/GenAiUpdateDetail. This is a
complex type whose value must be valid JSON. The value can be provided
as a string on the command line or passed in as a file using the
file://path/to/file syntax.
...
This option is a JSON list with items of type GgcsUpdateDetail.  For
documentation on GgcsUpdateDetail please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/stack/20250830/datatypes/GgcsUpdateDetail. This is a
complex type whose value must be valid JSON. The value can be provided
as a string on the command line or passed in as a file using the
file://path/to/file syntax.
...
ObjectStorageUpdateDetail.  For documentation on
ObjectStorageUpdateDetail please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/stack/20250830/datatypes/ObjectStorageUpdateDetail.
This is a complex type whose value must be valid JSON. The value can
be provided as a string on the command line or passed in as a file
using the file://path/to/file syntax.
...
security policies before trying the examples.
       ...
       oci dif stack update --stack-id $stack_id
