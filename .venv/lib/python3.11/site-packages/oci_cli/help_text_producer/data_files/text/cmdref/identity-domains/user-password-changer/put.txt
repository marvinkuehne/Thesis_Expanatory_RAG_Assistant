...
The password attribute. The maximum length for the password is set in
the password policy.

**SCIM++ Properties:**  - type: string  - multiValued: false  -
required: true  - mutability: writeOnly  - returned: never  -
uniqueness: none  - idcsSensitive: none
...
Indicates whether to send an email notification after a password is
changed.
...
Specifies the EmailTemplate to be used when sending a notification to
