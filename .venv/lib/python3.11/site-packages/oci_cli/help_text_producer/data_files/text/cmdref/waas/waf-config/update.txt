...
documentation on AccessRule please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/waas/20181116/datatypes/AccessRule. This is a complex
...
documentation on CachingRule please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/waas/20181116/datatypes/CachingRule. This is a
...
documentation on Captcha please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/waas/20181116/datatypes/Captcha. This is a complex
type whose value must be valid JSON. The value can be provided as a
string on the command line or passed in as a file using the
file://path/to/file syntax.
...
CustomProtectionRuleSetting please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/waas/20181116/datatypes/CustomProtectionRuleSetting.
...
documentation on GoodBot please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/waas/20181116/datatypes/GoodBot. This is a complex
type whose value must be valid JSON. The value can be provided as a
string on the command line or passed in as a file using the
file://path/to/file syntax.
...
documentation on ProtectionRule please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/waas/20181116/datatypes/ProtectionRule. This is a
complex type whose value must be valid JSON. The value can be provided
as a string on the command line or passed in as a file using the
file://path/to/file syntax.
...
documentation on ThreatFeed please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/waas/20181116/datatypes/ThreatFeed. This is a complex
type whose value must be valid JSON. The value can be provided as a
string on the command line or passed in as a file using the
file://path/to/file syntax.
...
documentation on Whitelist please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/waas/20181116/datatypes/Whitelist. This is a complex
type whose value must be valid JSON. The value can be provided as a
string on the command line or passed in as a file using the
file://path/to/file syntax.
