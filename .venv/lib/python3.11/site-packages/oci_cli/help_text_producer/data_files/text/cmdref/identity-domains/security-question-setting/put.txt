...
--max-field-length [integer]

Indicates the maximum length of following fields Security Questions,
Answer and Hint

**SCIM++ Properties:**  - type: integer  - multiValued: false  -
returned: default  - caseExact: false  - mutability: readWrite  -
required: true  - uniqueness: none  - idcsMinValue: 5  - idcsMaxValue:
100

--min-answer-length [integer]

Indicates the minimum length of answer for security questions

**SCIM++ Properties:**  - type: integer  - multiValued: false  -
required: true  - caseExact: false  - mutability: readWrite  -
returned: default  - uniqueness: none  - idcsMinValue: 1  -
idcsMaxValue: 8

--num-questions-to-ans [integer]

Indicates the number of security questions that a user must answer

**SCIM++ Properties:**  - type: integer  - multiValued: false  -
returned: default  - caseExact: false  - mutability: readWrite  -
required: true  - uniqueness: none  - idcsMinValue: 1  - idcsMaxValue:
5

--num-questions-to-setup [integer]
...
--security-question-setting-id [text]
