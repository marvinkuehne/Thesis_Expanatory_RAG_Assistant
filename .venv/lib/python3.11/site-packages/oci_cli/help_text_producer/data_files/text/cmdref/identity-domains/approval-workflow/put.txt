...
--approval-workflow-id [text]

ID of the resource

--max-duration [complex type]
...
--approval-workflow-steps [complex type]
...
ApprovalWorkflowApprovalWorkflowSteps.  For documentation on
ApprovalWorkflowApprovalWorkflowSteps please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/identitydomains/v1/dataty
pes/ApprovalWorkflowApprovalWorkflowSteps. This is a complex type
