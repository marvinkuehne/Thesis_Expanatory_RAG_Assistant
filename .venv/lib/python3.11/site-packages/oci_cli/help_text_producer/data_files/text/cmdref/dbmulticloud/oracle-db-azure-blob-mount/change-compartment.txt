...
Moves the Oracle DB Azure Blob Mount resource into a different
...
=====
   ...
   oci dbmulticloud oracle-db-azure-blob-mount change-compartment [OPTIONS]
...
The ID of the new compartment to contain the Oracle DB Azure Blob
Mount resource.
...
security policies before trying the examples.
       ...
       oci dbmulticloud oracle-db-azure-blob-mount change-compartment --oracle-db-azure-blob-mount-id $oracle_db_azure_blob_mount_id
