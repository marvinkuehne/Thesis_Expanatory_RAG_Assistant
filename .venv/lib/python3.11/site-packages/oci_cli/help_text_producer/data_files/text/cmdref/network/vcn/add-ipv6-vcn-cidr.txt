...
Add an IPv6 prefix to a VCN. The VCN size is always /56 and assigned
by Oracle. Once added the IPv6 prefix cannot be removed or modified.
...
--byoipv6-cidr-detail [complex type]
...
--ipv6-private-cidr-block [text]

This field is not required and should only be specified if a ULA or
private IPv6 prefix is desired for VCN’s private IP address space.
See`IPv6 Addresses <https://docs.cloud.oracle.com/iaas/Content/Networ
k/Concepts/ipv6.htm>`__.

Example:

   2001:0db8:0123::/48` or `fd00:1000:0:1::/64

--is-oracle-gua-allocation-enabled [boolean]

Indicates whether Oracle will allocate an IPv6 GUA. Only one prefix of
/56 size can be allocated by Oracle as a GUA.
