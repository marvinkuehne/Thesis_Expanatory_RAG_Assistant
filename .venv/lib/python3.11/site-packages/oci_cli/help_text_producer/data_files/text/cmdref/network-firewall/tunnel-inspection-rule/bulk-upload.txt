...
Creates a new Tunnel Inspection Rule at bulk for the Network Firewall
Policy.
...
--bulk-upload-tunnel-inspection-rules-details [complex type]

Request Details to bulk import tunnel inspection rules for the Network
...
example parameters with your own.
       ...
       oci network-firewall tunnel-inspection-rule bulk-upload --generate-param-json-input bulk-upload-tunnel-inspection-rules-details > bulk-upload-tunnel-inspection-rules-details.json
...
security policies before trying the examples.
       ...
       oci network-firewall tunnel-inspection-rule bulk-upload --bulk-upload-tunnel-inspection-rules-details file://bulk-upload-tunnel-inspection-rules-details.json --network-firewall-policy-id $network_firewall_policy_id
