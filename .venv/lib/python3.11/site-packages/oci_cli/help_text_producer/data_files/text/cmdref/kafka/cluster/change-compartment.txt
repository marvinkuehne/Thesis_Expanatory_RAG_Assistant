...
Moves a KafkaCluster into a different compartment within the same
...
=====
   ...
   oci kafka cluster change-compartment [OPTIONS]
...
The OCID of the compartment to move the KafkaCluster to.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/kafka/cluster/change-compartment.html#cmdoption-compartment-id
       export kafka_cluster_id=<substitute-value-of-kafka_cluster_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/kafka/cluster/change-compartment.html#cmdoption-kafka-cluster-id

       oci kafka cluster change-compartment --compartment-id $compartment_id --kafka-cluster-id $kafka_cluster_id
