...
--cloud-gate-mapping-id [text]

ID of the resource

--gateway-app [complex type]
...
The Web Tier policy name used for the App that is mapped to the owning
Cloud Gate
...
Resource prefix for this mapping.  This will be used to define the
location block
...
More NGINX Settings. JSON encoded key value pairs similar to WTP
encoding
...
--upstream-server-group [complex type]
