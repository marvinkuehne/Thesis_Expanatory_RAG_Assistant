...
Moves the Oracle DB Azure Vault Association resource into a different
...
=====
   ...
   oci dbmulticloud oracle-db-azure-vault-association change-compartment [OPTIONS]
...
The OCID of the new compartment to contain the Oracle DB Azure Vault
...
security policies before trying the examples.
       ...
       oracle_db_azure_vault_association_id=$(oci dbmulticloud oracle-db-azure-vault-association create --compartment-id $compartment_id --display-name $display_name --oracle-db-azure-connector-id $oracle_db_azure_connector_id --oracle-db-azure-vault-id $oracle_db_azure_vault_id --query data.id --raw-output)

       oci dbmulticloud oracle-db-azure-vault-association change-compartment --oracle-db-azure-vault-association-id $oracle_db_azure_vault_association_id
