...
An array of security rules to add to the NSG. You can add up to 25
rules in a single *AddNetworkSecurityGroupSecurityRules* operation.
Adding more than 25 rules requires multiple operations.

This option is a JSON list with items of type AddSecurityRuleDetails.
For documentation on AddSecurityRuleDetails please see our API
reference: https://docs.oracle.com/en-
us/iaas/api/#/en/iaas/20160918/datatypes/AddSecurityRuleDetails. This
