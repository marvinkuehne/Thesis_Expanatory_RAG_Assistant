...
=====
   ...
   oci database-migration assessor-check-summary list-assessor-checks [OPTIONS]
...
security policies before trying the examples.
       ...
       export assessor_name=<substitute-value-of-assessor_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-migration/assessor-check-summary/list-assessor-checks.html#cmdoption-assessor-name
       ...
       oci database-migration assessor-check-summary list-assessor-checks --assessment-id $assessment_id --assessor-name $assessor_name --compartment-id $compartment_id
