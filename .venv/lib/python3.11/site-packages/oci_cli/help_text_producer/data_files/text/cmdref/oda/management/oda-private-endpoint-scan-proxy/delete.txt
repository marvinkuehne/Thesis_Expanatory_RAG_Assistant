...
Starts an asynchronous job to delete the specified ODA Private
Endpoint Scan Proxy. To monitor the status of the job, take the *opc-
work-request-id* response header value and use it to call *GET
...
--oda-private-endpoint-scan-proxy-id [text]
