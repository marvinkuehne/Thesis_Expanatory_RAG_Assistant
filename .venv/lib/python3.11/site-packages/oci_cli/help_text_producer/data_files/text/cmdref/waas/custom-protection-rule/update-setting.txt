...
*DETECT* and *BLOCK* actions can be set. Disabled rules should not be
included in the list. For more information on protection rules, see
...
--custom-protection-rules-details [complex type]
