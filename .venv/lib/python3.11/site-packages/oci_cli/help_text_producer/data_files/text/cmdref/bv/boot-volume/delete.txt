...
connection to an instance. To disconnect the boot volume from a
connected instance, see Disconnecting From a Boot Volume. **Warning:**
All data on the boot volume will be permanently lost when the boot
volume is deleted.
