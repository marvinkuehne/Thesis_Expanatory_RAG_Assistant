...
documentation on Message please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/generativeaiinference/20231130/datatypes/Message.
This is a complex type whose value must be valid JSON. The value can
be provided as a string on the command line or passed in as a file
using the file://path/to/file syntax.
...
documentation on ToolDefinition please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/generativeaiinference/202
31130/datatypes/ToolDefinition. This is a complex type whose value
