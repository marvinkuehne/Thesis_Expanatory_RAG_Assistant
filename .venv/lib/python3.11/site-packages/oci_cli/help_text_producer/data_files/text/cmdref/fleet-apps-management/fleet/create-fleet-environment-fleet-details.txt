"create-fleet-environment-fleet-details"
****************************************
...
=====
   ...
   oci fleet-apps-management fleet create-fleet-environment-fleet-details [OPTIONS]
...
--resource-selection [complex type]
...
example parameters with your own.
       ...
       oci fleet-apps-management fleet create-fleet-environment-fleet-details --generate-param-json-input resource-selection > resource-selection.json
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fleet-apps-management/fleet/create-fleet-environment-fleet-details.html#cmdoption-compartment-id
       export display_name=<substitute-value-of-display_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fleet-apps-management/fleet/create-fleet-environment-fleet-details.html#cmdoption-display-name

       oci fleet-apps-management fleet create-fleet-environment-fleet-details --compartment-id $compartment_id --display-name $display_name --resource-selection file://resource-selection.json
