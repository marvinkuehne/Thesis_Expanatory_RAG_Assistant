...
Moves a Provision into a different compartment within the same
...
=====
   ...
   oci fleet-apps-management fleet-apps-management-provision provision change-compartment [OPTIONS]
...
The OCID of the compartment to move the FamProvision to.
...
security policies before trying the examples.
       ...
       oci fleet-apps-management fleet-apps-management-provision provision change-compartment --compartment-id $compartment_id --provision-id $provision_id
