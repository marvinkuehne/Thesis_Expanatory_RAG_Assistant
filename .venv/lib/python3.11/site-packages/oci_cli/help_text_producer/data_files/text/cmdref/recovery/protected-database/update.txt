...
The size of the database is allowed to be decreased. XS - Less than
5GB, S - 5GB to 50GB, M - 50GB to 500GB, L - 500GB to 1TB, XL - 1TB to
5TB, XXL - Greater than 5TB.
...
between successive archived redo log backups. For this to be
effective, additional configuration is needed on client side.
...
username “admin”, regardless of casing. Password must not be same as
current passsword.
...
RecoveryServiceSubnetInput.  For documentation on
RecoveryServiceSubnetInput please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/databaserecovery/20210216
/datatypes/RecoveryServiceSubnetInput. This is a complex type whose
