...
--prechecks-enabled [boolean]

A flag indicating whether prechecks should be executed before the plan
execution.
...
--warnings-ignored [boolean]

A flag indicating whether warnings should be ignored during the plan
execution.
