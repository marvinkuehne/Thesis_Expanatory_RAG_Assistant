...
Creates a virtual test access point (VTAP) in the specified
compartment.
...
=====
   ...
   oci network vtap create [OPTIONS]
...
security policies before trying the examples.
       ...
       oci network vtap create --capture-filter-id $capture_filter_id --compartment-id $compartment_id --source-id $source_id --vcn-id $vcn_id
