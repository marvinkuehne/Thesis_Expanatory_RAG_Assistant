...
Request to perform crypto analysis on one or more selected targets in
the Fleet. The result of the crypto analysis will be uploaded to the
object storage bucket created by JMS on enabling the Crypto Event
Analysis feature in the Fleet.
...
https://docs.oracle.com/en-us/iaas/api/#/en/javamanagementservice/202
10610/datatypes/JfrAttachmentTarget. This is a complex type whose
