"clone-assessment-oracle-clone-assessment-details"
**************************************************
...
=====
   ...
   oci database-migration assessment clone-assessment-oracle-clone-assessment-details [OPTIONS]
...
example parameters with your own.
       ...
       oci database-migration assessment clone-assessment-oracle-clone-assessment-details --generate-param-json-input source-database-connection > source-database-connection.json
       oci database-migration assessment clone-assessment-oracle-clone-assessment-details --generate-param-json-input target-database-connection > target-database-connection.json
...
security policies before trying the examples.
       ...
       oci database-migration assessment clone-assessment-oracle-clone-assessment-details --assessment-id $assessment_id --source-database-connection file://source-database-connection.json --target-database-connection file://target-database-connection.json
