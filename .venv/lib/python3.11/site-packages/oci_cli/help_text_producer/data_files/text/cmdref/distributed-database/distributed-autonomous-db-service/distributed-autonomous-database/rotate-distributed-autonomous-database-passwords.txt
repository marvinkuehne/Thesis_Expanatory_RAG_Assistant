"rotate-distributed-autonomous-database-passwords"
**************************************************
...
=====
   ...
   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database rotate-distributed-autonomous-database-passwords [OPTIONS]
...
security policies before trying the examples.
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database rotate-distributed-autonomous-database-passwords --distributed-autonomous-database-id $distributed_autonomous_database_id
