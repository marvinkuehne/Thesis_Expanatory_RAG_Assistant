...
Updates the specified security list’s display name or rules. Avoid
entering confidential information.

Note that the *egressSecurityRules* or *ingressSecurityRules* objects
you provide replace the entire existing objects.
...
This option is a JSON list with items of type EgressSecurityRule.  For
documentation on EgressSecurityRule please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/iaas/20160918/datatypes/EgressSecurityRule. This is a
...
This option is a JSON list with items of type IngressSecurityRule.
For documentation on IngressSecurityRule please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/iaas/20160918/datatypes/IngressSecurityRule. This is
