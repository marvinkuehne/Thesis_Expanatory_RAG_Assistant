...
=====
   ...
   oci database-management cloud-db-system disable-cloud-db-system-stack-monitoring [OPTIONS]
...
security policies before trying the examples.
       ...
       oci database-management cloud-db-system disable-cloud-db-system-stack-monitoring --cloud-db-system-id $cloud_db_system_id
