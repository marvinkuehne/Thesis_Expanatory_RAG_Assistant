...
Deletes the specified route table, but only if it’s not associated
with a subnet. You can’t delete a VCN’s default route table.

This is an asynchronous operation. The route table’s *lifecycleState*
will change to TERMINATING temporarily until the route table is
completely removed.
