...
Moves the attribute set to the specified compartment. When provided,
if-Match is checked against ETag value of the resource.


Usage
=====

   oci data-safe attribute-set change-compartment [OPTIONS]
...
The OCID of the new compartment were attribute set resource would
move.
...
security policies before trying the examples.
       ...
       oci data-safe attribute-set change-compartment --attribute-set-id $attribute_set_id --compartment-id $compartment_id
