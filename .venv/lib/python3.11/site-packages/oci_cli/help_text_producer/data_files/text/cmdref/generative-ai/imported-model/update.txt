...
Updates the properties of an imported model such as name, description,
freeform tags, and defined tags.


Usage
=====

   oci generative-ai imported-model update [OPTIONS]
...
security policies before trying the examples.
       ...
       export imported_model_id=<substitute-value-of-imported_model_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/generative-ai/imported-model/update.html#cmdoption-imported-model-id

       oci generative-ai imported-model update --imported-model-id $imported_model_id
