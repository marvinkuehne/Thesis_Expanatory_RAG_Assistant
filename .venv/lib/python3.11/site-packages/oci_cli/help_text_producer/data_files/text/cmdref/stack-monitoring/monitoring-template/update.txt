...
A user-friendly description for the monitoring template. It does not
...
represented by the OCID of a related resource This is a complex type
...
A user-friendly name for the monitoring template. It is unique and
mutable in nature.
...
--is-alarms-enabled [boolean]

User can create the out of box alarm only for multiple resourceTypes
not for individual resource instances and groups for specified
compartment.
...
This option is a JSON list with items of type MemberReference.  For
documentation on MemberReference please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/stackmonitoring/20210330/datatypes/MemberReference.
...
--split-notif-enabled [boolean]

Whether the alarm notification is enabled or disabled, it will be
Enabled by default.
