...
Creates a responder recipe (ResponderRecipe resource), from values
passed in a CreateResponderRecipeDetails resource.
...
--source-responder-recipe-id [text]
...
UpdateResponderRecipeResponderRule.  For documentation on
UpdateResponderRecipeResponderRule please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/cloudguard/20200131/datat
ypes/UpdateResponderRecipeResponderRule. This is a complex type whose
value must be valid JSON. The value can be provided as a string on the
command line or passed in as a file using the file://path/to/file
syntax.
