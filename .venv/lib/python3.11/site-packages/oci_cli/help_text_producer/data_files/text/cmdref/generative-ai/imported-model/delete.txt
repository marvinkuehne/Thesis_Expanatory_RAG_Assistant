...
Deletes an imported model. An imported model shouldn’t be deleted if
there’s one or more active endpoints associated with that imported
model.
...
=====
   ...
   oci generative-ai imported-model delete [OPTIONS]
...
security policies before trying the examples.
       ...
       export imported_model_id=<substitute-value-of-imported_model_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/generative-ai/imported-model/delete.html#cmdoption-imported-model-id

       oci generative-ai imported-model delete --imported-model-id $imported_model_id
