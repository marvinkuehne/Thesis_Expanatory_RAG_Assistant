...
function GetOciSubcommands_adm() {
    $ociSubcommands = @{
        ...
        'adm vulnerability-audit' = 'change-compartment create create-vulnerability-audit-external-resource-vulnerability-audit-source create-vulnerability-audit-oci-resource-vulnerability-audit-source create-vulnerability-audit-unknown-source-vulnerability-audit-source delete get list list-application-dependency-vulnerabilities list-vulnerabilities update'
...
function GetOciCommandsToLongParams_adm() {
    $ociCommandsToLongParams = @{
        ...
        'adm vulnerability-audit list-vulnerabilities' = 'all from-json help is-direct-vulnerability limit page page-size vulnerability-audit-id'
...
function GetOciCommandsToShortParams_adm() {
    $ociCommandsToShortParams = @{
        ...
        'adm vulnerability-audit list-vulnerabilities' = '? h'
