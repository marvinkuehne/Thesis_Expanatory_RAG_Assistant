...
class AddressServiceClient(object):
    ...
    def get_address(self, osp_home_region, compartment_id, address_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/ospgateway/get_address.py.html>`__ to see an example of how to use get_address API.
        """
    ...
    def verify_address(self, osp_home_region, compartment_id, verify_address_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/ospgateway/verify_address.py.html>`__ to see an example of how to use verify_address API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
