...
class AddressRuleServiceClient(object):
    ...
    def get_address_rule(self, osp_home_region, compartment_id, country_code, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/ospgateway/get_address_rule.py.html>`__ to see an example of how to use get_address_rule API.
        """
