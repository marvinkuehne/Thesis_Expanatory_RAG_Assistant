...
class FleetAppsManagementCatalogClient(object):
    ...
    def change_catalog_item_compartment(self, catalog_item_id, change_catalog_item_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/fleetappsmanagement/change_catalog_item_compartment.py.html>`__ to see an example of how to use change_catalog_item_compartment API.
        """
    ...
    def clone_catalog_item(self, catalog_item_id, clone_catalog_item_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/fleetappsmanagement/clone_catalog_item.py.html>`__ to see an example of how to use clone_catalog_item API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogItemId']
    ...
    def configure_catalog_item(self, catalog_item_id, configure_catalog_item_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/fleetappsmanagement/configure_catalog_item.py.html>`__ to see an example of how to use configure_catalog_item API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogItemId']
    ...
    def create_catalog_item(self, create_catalog_item_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/fleetappsmanagement/create_catalog_item.py.html>`__ to see an example of how to use create_catalog_item API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_catalog_item(self, catalog_item_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/fleetappsmanagement/delete_catalog_item.py.html>`__ to see an example of how to use delete_catalog_item API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogItemId']
    ...
    def get_catalog_item(self, catalog_item_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/fleetappsmanagement/get_catalog_item.py.html>`__ to see an example of how to use get_catalog_item API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogItemId']
        resource_path = "/catalogItems/{catalogItemId}"
    ...
    def get_catalog_item_variables_definition(self, catalog_item_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/fleetappsmanagement/get_catalog_item_variables_definition.py.html>`__ to see an example of how to use get_catalog_item_variables_definition API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogItemId']
    ...
    def list_catalog_items(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/fleetappsmanagement/list_catalog_items.py.html>`__ to see an example of how to use list_catalog_items API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_catalog_item(self, catalog_item_id, update_catalog_item_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/fleetappsmanagement/update_catalog_item.py.html>`__ to see an example of how to use update_catalog_item API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['catalogItemId']
        resource_path = "/catalogItems/{catalogItemId}"
