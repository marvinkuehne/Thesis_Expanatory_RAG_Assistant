...
class SubscribersClient(object):
    ...
    def add_subscriber_lock(self, subscriber_id, add_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/apigateway/add_subscriber_lock.py.html>`__ to see an example of how to use add_subscriber_lock API.
        """
    ...
    def change_subscriber_compartment(self, subscriber_id, change_subscriber_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/apigateway/change_subscriber_compartment.py.html>`__ to see an example of how to use change_subscriber_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['subscriberId']
    ...
    def create_subscriber(self, create_subscriber_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/apigateway/create_subscriber.py.html>`__ to see an example of how to use create_subscriber API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_subscriber(self, subscriber_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/apigateway/delete_subscriber.py.html>`__ to see an example of how to use delete_subscriber API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['subscriberId']
    ...
    def get_subscriber(self, subscriber_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/apigateway/get_subscriber.py.html>`__ to see an example of how to use get_subscriber API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['subscriberId']
        resource_path = "/subscribers/{subscriberId}"
    ...
    def list_subscribers(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/apigateway/list_subscribers.py.html>`__ to see an example of how to use list_subscribers API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def remove_subscriber_lock(self, subscriber_id, remove_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/apigateway/remove_subscriber_lock.py.html>`__ to see an example of how to use remove_subscriber_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['subscriberId']
    ...
    def update_subscriber(self, subscriber_id, update_subscriber_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/apigateway/update_subscriber.py.html>`__ to see an example of how to use update_subscriber API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['subscriberId']
        resource_path = "/subscribers/{subscriberId}"
