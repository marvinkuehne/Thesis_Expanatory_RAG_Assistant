...
class OpensearchClusterBackupClient(object):
    ...
    def delete_opensearch_cluster_backup(self, opensearch_cluster_backup_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/opensearch/delete_opensearch_cluster_backup.py.html>`__ to see an example of how to use delete_opensearch_cluster_backup API.
        """
    ...
    def get_opensearch_cluster_backup(self, opensearch_cluster_backup_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/opensearch/get_opensearch_cluster_backup.py.html>`__ to see an example of how to use get_opensearch_cluster_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['opensearchClusterBackupId']
        resource_path = "/opensearchClusterBackups/{opensearchClusterBackupId}"
    ...
    def list_opensearch_cluster_backups(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/opensearch/list_opensearch_cluster_backups.py.html>`__ to see an example of how to use list_opensearch_cluster_backups API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_opensearch_cluster_backup(self, opensearch_cluster_backup_id, update_opensearch_cluster_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/opensearch/update_opensearch_cluster_backup.py.html>`__ to see an example of how to use update_opensearch_cluster_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['opensearchClusterBackupId']
        resource_path = "/opensearchClusterBackups/{opensearchClusterBackupId}"
