...
class MacDeviceClient(object):
    ...
    def get_mac_device(self, mac_device_id, mac_order_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/mngdmac/get_mac_device.py.html>`__ to see an example of how to use get_mac_device API.
        """
    ...
    def list_mac_devices(self, mac_order_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/mngdmac/list_mac_devices.py.html>`__ to see an example of how to use list_mac_devices API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def terminate_mac_device(self, mac_device_id, mac_order_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/mngdmac/terminate_mac_device.py.html>`__ to see an example of how to use terminate_mac_device API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['macDeviceId', 'macOrderId']
