...
class ReplicasClient(object):
    ...
    def create_replica(self, create_replica_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/mysql/create_replica.py.html>`__ to see an example of how to use create_replica API.
        """
    ...
    def delete_replica(self, replica_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/mysql/delete_replica.py.html>`__ to see an example of how to use delete_replica API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_replica(self, replica_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/mysql/get_replica.py.html>`__ to see an example of how to use get_replica API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['replicaId']
        resource_path = "/replicas/{replicaId}"
    ...
    def list_replicas(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/mysql/list_replicas.py.html>`__ to see an example of how to use list_replicas API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_replica(self, replica_id, update_replica_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/mysql/update_replica.py.html>`__ to see an example of how to use update_replica API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['replicaId']
        resource_path = "/replicas/{replicaId}"
