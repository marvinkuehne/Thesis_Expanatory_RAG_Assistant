...
class ManagementStationClient(object):
    ...
    def change_management_station_compartment(self, management_station_id, change_management_station_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/change_management_station_compartment.py.html>`__ to see an example of how to use change_management_station_compartment API.
        """
    ...
    def create_management_station(self, create_management_station_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/create_management_station.py.html>`__ to see an example of how to use create_management_station API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_management_station(self, management_station_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/delete_management_station.py.html>`__ to see an example of how to use delete_management_station API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['managementStationId']
    ...
    def get_management_station(self, management_station_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/get_management_station.py.html>`__ to see an example of how to use get_management_station API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['managementStationId']
        resource_path = "/managementStations/{managementStationId}"
    ...
    def list_management_stations(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/list_management_stations.py.html>`__ to see an example of how to use list_management_stations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/managementStations"
    ...
    def list_mirrors(self, management_station_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/list_mirrors.py.html>`__ to see an example of how to use list_mirrors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['managementStationId']
    ...
    def refresh_management_station_config(self, management_station_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/refresh_management_station_config.py.html>`__ to see an example of how to use refresh_management_station_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['managementStationId']
    ...
    def synchronize_mirrors(self, management_station_id, synchronize_mirrors_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/synchronize_mirrors.py.html>`__ to see an example of how to use synchronize_mirrors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['managementStationId']
    ...
    def synchronize_single_mirrors(self, management_station_id, mirror_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/synchronize_single_mirrors.py.html>`__ to see an example of how to use synchronize_single_mirrors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_management_station(self, management_station_id, update_management_station_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/update_management_station.py.html>`__ to see an example of how to use update_management_station API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['managementStationId']
        resource_path = "/managementStations/{managementStationId}"
