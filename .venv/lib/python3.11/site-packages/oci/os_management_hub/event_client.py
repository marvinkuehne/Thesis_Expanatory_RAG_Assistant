...
class EventClient(object):
    ...
    def change_event_compartment(self, change_event_compartment_details, event_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/change_event_compartment.py.html>`__ to see an example of how to use change_event_compartment API.
        """
    ...
    def delete_event(self, event_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/delete_event.py.html>`__ to see an example of how to use delete_event API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['eventId']
    ...
    def delete_event_content(self, event_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/delete_event_content.py.html>`__ to see an example of how to use delete_event_content API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['eventId']
    ...
    def get_event(self, event_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/get_event.py.html>`__ to see an example of how to use get_event API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['eventId']
        resource_path = "/events/{eventId}"
    ...
    def get_event_content(self, event_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/get_event_content.py.html>`__ to see an example of how to use get_event_content API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['eventId']
        resource_path = "/events/{eventId}/content"
    ...
    def import_event_content(self, event_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/import_event_content.py.html>`__ to see an example of how to use import_event_content API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['eventId']
    ...
    def list_events(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/list_events.py.html>`__ to see an example of how to use list_events API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def update_event(self, event_id, update_event_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/osmanagementhub/update_event.py.html>`__ to see an example of how to use update_event API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['eventId']
        resource_path = "/events/{eventId}"
