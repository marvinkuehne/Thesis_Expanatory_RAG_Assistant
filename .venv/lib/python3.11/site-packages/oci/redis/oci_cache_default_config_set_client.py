...
class OciCacheDefaultConfigSetClient(object):
    ...
    def get_oci_cache_default_config_set(self, compartment_id, oci_cache_default_config_set_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/redis/get_oci_cache_default_config_set.py.html>`__ to see an example of how to use get_oci_cache_default_config_set API.
        """
    ...
    def list_oci_cache_default_config_sets(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/redis/list_oci_cache_default_config_sets.py.html>`__ to see an example of how to use list_oci_cache_default_config_sets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
