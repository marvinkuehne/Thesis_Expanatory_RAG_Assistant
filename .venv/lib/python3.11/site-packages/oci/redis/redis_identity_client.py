...
class RedisIdentityClient(object):
    ...
    def create_identity_token(self, create_identity_token_details, redis_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/redis/create_identity_token.py.html>`__ to see an example of how to use create_identity_token API.
        """
