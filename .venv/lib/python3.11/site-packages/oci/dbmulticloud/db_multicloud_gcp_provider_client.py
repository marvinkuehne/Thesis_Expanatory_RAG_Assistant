...
class DbMulticloudGCPProviderClient(object):
    ...
    def change_oracle_db_gcp_identity_connector_compartment(self, oracle_db_gcp_identity_connector_id, change_oracle_db_gcp_identity_connector_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/change_oracle_db_gcp_identity_connector_compartment.py.html>`__ to see an example of how to use change_oracle_db_gcp_identity_connector_compartment API.
        """
    ...
    def change_oracle_db_gcp_key_ring_compartment(self, oracle_db_gcp_key_ring_id, change_oracle_db_gcp_key_ring_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/change_oracle_db_gcp_key_ring_compartment.py.html>`__ to see an example of how to use change_oracle_db_gcp_key_ring_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_oracle_db_gcp_identity_connector(self, create_oracle_db_gcp_identity_connector_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/create_oracle_db_gcp_identity_connector.py.html>`__ to see an example of how to use create_oracle_db_gcp_identity_connector API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_oracle_db_gcp_key_ring(self, create_oracle_db_gcp_key_ring_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/create_oracle_db_gcp_key_ring.py.html>`__ to see an example of how to use create_oracle_db_gcp_key_ring API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_oracle_db_gcp_identity_connector(self, oracle_db_gcp_identity_connector_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/delete_oracle_db_gcp_identity_connector.py.html>`__ to see an example of how to use delete_oracle_db_gcp_identity_connector API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbGcpIdentityConnectorId']
    ...
    def delete_oracle_db_gcp_key_ring(self, oracle_db_gcp_key_ring_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/delete_oracle_db_gcp_key_ring.py.html>`__ to see an example of how to use delete_oracle_db_gcp_key_ring API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbGcpKeyRingId']
    ...
    def get_oracle_db_gcp_identity_connector(self, oracle_db_gcp_identity_connector_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/get_oracle_db_gcp_identity_connector.py.html>`__ to see an example of how to use get_oracle_db_gcp_identity_connector API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbGcpIdentityConnectorId']
        resource_path = "/oracleDbGcpIdentityConnector/{oracleDbGcpIdentityConnectorId}"
    ...
    def get_oracle_db_gcp_key(self, oracle_db_gcp_key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/get_oracle_db_gcp_key.py.html>`__ to see an example of how to use get_oracle_db_gcp_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_oracle_db_gcp_key_ring(self, oracle_db_gcp_key_ring_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/get_oracle_db_gcp_key_ring.py.html>`__ to see an example of how to use get_oracle_db_gcp_key_ring API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbGcpKeyRingId']
        resource_path = "/oracleDbGcpKeyRing/{oracleDbGcpKeyRingId}"
    ...
    def list_oracle_db_gcp_identity_connectors(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/list_oracle_db_gcp_identity_connectors.py.html>`__ to see an example of how to use list_oracle_db_gcp_identity_connectors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_oracle_db_gcp_key_rings(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/list_oracle_db_gcp_key_rings.py.html>`__ to see an example of how to use list_oracle_db_gcp_key_rings API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/oracleDbGcpKeyRing"
    ...
    def list_oracle_db_gcp_keys(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/list_oracle_db_gcp_keys.py.html>`__ to see an example of how to use list_oracle_db_gcp_keys API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def refresh_oracle_db_gcp_identity_connector(self, oracle_db_gcp_identity_connector_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/refresh_oracle_db_gcp_identity_connector.py.html>`__ to see an example of how to use refresh_oracle_db_gcp_identity_connector API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbGcpIdentityConnectorId']
    ...
    def refresh_oracle_db_gcp_key_ring(self, oracle_db_gcp_key_ring_id, refresh_oracle_db_gcp_key_ring_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/refresh_oracle_db_gcp_key_ring.py.html>`__ to see an example of how to use refresh_oracle_db_gcp_key_ring API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbGcpKeyRingId']
    ...
    def update_oracle_db_gcp_identity_connector(self, oracle_db_gcp_identity_connector_id, update_oracle_db_gcp_identity_connector_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/update_oracle_db_gcp_identity_connector.py.html>`__ to see an example of how to use update_oracle_db_gcp_identity_connector API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbGcpIdentityConnectorId']
        resource_path = "/oracleDbGcpIdentityConnector/{oracleDbGcpIdentityConnectorId}"
    ...
    def update_oracle_db_gcp_key_ring(self, oracle_db_gcp_key_ring_id, update_oracle_db_gcp_key_ring_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/dbmulticloud/update_oracle_db_gcp_key_ring.py.html>`__ to see an example of how to use update_oracle_db_gcp_key_ring API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbGcpKeyRingId']
        resource_path = "/oracleDbGcpKeyRing/{oracleDbGcpKeyRingId}"
