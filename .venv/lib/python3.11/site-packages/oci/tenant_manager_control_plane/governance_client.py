...
class GovernanceClient(object):
    ...
    def add_governance(self, organization_id, organization_tenancy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/tenantmanagercontrolplane/add_governance.py.html>`__ to see an example of how to use add_governance API.
        """
    ...
    def remove_governance(self, organization_id, organization_tenancy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/tenantmanagercontrolplane/remove_governance.py.html>`__ to see an example of how to use remove_governance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['organizationId', 'organizationTenancyId']
