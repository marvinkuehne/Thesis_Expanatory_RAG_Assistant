...
class MonitoredRegionClient(object):
    ...
    def create_monitored_region(self, create_monitored_region_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/resourceanalytics/create_monitored_region.py.html>`__ to see an example of how to use create_monitored_region API.
        """
    ...
    def delete_monitored_region(self, monitored_region_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/resourceanalytics/delete_monitored_region.py.html>`__ to see an example of how to use delete_monitored_region API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_monitored_region(self, monitored_region_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/resourceanalytics/get_monitored_region.py.html>`__ to see an example of how to use get_monitored_region API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['monitoredRegionId']
        resource_path = "/monitoredRegions/{monitoredRegionId}"
    ...
    def list_monitored_regions(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/resourceanalytics/list_monitored_regions.py.html>`__ to see an example of how to use list_monitored_regions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/monitoredRegions"
