...
class OmhubResourceAnchorClient(object):
    ...
    def get_resource_anchor(self, resource_anchor_id, subscription_service_name, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/multicloud/get_resource_anchor.py.html>`__ to see an example of how to use get_resource_anchor API.
        """
    ...
    def list_resource_anchors(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/multicloud/list_resource_anchors.py.html>`__ to see an example of how to use list_resource_anchors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
