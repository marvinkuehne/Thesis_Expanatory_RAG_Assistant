...
class MetadataClient(object):
    ...
    def list_external_location_details_metadata(self, subscription_id, subscription_service_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/multicloud/list_external_location_details_metadata.py.html>`__ to see an example of how to use list_external_location_details_metadata API.
        """
    ...
    def list_external_location_mapping_metadata(self, subscription_service_name, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/multicloud/list_external_location_mapping_metadata.py.html>`__ to see an example of how to use list_external_location_mapping_metadata API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_external_location_summaries_metadata(self, subscription_service_name, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/multicloud/list_external_location_summaries_metadata.py.html>`__ to see an example of how to use list_external_location_summaries_metadata API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['subscriptionServiceName', 'compartmentId']
