...
class MulticloudsubscriptionsClient(object):
    ...
    def list_multicloud_subscriptions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/multicloud/list_multicloud_subscriptions.py.html>`__ to see an example of how to use list_multicloud_subscriptions API.
        """
