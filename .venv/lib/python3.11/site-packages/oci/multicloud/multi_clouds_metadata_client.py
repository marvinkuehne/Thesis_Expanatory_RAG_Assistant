...
class MultiCloudsMetadataClient(object):
    ...
    def get_multi_cloud_metadata(self, compartment_id, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/multicloud/get_multi_cloud_metadata.py.html>`__ to see an example of how to use get_multi_cloud_metadata API.
        """
    ...
    def list_multi_cloud_metadata(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/multicloud/list_multi_cloud_metadata.py.html>`__ to see an example of how to use list_multi_cloud_metadata API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
