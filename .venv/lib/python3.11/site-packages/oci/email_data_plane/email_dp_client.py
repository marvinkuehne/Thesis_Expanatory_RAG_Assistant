...
class EmailDPClient(object):
    ...
    def submit_email(self, submit_email_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/emaildataplane/submit_email.py.html>`__ to see an example of how to use submit_email API.
        """
    ...
    def submit_raw_email(self, content_type, compartment_id, sender, recipients, raw_message, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/emaildataplane/submit_raw_email.py.html>`__ to see an example of how to use submit_raw_email API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
