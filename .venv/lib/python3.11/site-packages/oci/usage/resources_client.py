...
class ResourcesClient(object):
    ...
    def list_resource_quota(self, service_name, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/usage/list_resource_quota.py.html>`__ to see an example of how to use list_resource_quota API.
        """
    ...
    def list_resources(self, service_name, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.1/usage/list_resources.py.html>`__ to see an example of how to use list_resources API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['serviceName', 'compartmentId']
